clumioapi.controllers.types
===========================

.. automodule:: clumioapi.controllers.types
...
.. autosummary::
   ...
   audit_trails_types
   auto_user_provisioning_rules_types
   auto_user_provisioning_settings_types
   aws_connection_groups_types
   aws_connections_types
   aws_dynamodb_tables_types
   aws_ebs_volumes_types
   ...
   aws_regions_types
   aws_s3_buckets_types
   aws_s3_buckets_v1_bucket_matcher_types
   aws_templates_types
   ...
   consolidated_alerts_types
   ec2_mssql_availability_groups_types
   ec2_mssql_databases_types
   ec2_mssql_failover_cluster_types
   ...
   policy_assignments_types
   policy_definitions_types
   policy_rules_types
   post_process_aws_connection_types
   post_process_kms_types
   protection_groups_s3_assets_types
   protection_groups_types
   report_compliance_runs_types
   report_compliance_types
   report_downloads_types
   restore_ec2_mssql_database_types
   ...
   restored_records_aws_dynamodb_tables_types
   roles_types
   tasks_types
   users_types
   wallets_types
