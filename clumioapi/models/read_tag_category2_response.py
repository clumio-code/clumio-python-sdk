...
T = TypeVar('T', bound='ReadTagCategory2Response')


class ReadTagCategory2Response:
    """Implementation of the 'ReadTagCategory2Response' model.
    ...
    def __init__(
        ...
        """Constructor for the ReadTagCategory2Response class."""
