...
class OnDemandEBSBackupResponse:
    ...
    def __init__(
        ...
        links: on_demand_ebs_backup_links_.OnDemandEBSBackupLinks,
        task_id: str,
    ) -> None:
        """Constructor for the OnDemandEBSBackupResponse class."""

        # Initialize members of the class
        self.embedded: read_task_hateoas_outer_embedded_.ReadTaskHateoasOuterEmbedded = embedded
        self.links: on_demand_ebs_backup_links_.OnDemandEBSBackupLinks = links
