...
T = TypeVar('T', bound='MssqlInstanceListLinks')


class MssqlInstanceListLinks:
    """Implementation of the 'MssqlInstanceListLinks' model.
    ...
    def __init__(
        ...
        """Constructor for the MssqlInstanceListLinks class."""
