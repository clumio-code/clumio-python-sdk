...
T = TypeVar('T', bound='ReadEbsTagComplianceStatsResponse')


class ReadEbsTagComplianceStatsResponse:
    """Implementation of the 'ReadEbsTagComplianceStatsResponse' model.
    ...
    def __init__(
        ...
        """Constructor for the ReadEbsTagComplianceStatsResponse class."""
