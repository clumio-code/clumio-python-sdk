...
from clumioapi.models import operation_info
...
class BackupStatusInfo:
    ...
    def __init__(
        ...
        operation_info_list: Sequence[operation_info.OperationInfo] = None,
    ) -> None:
        ...
        self.operation_info_list: Sequence[operation_info.OperationInfo] = operation_info_list
    ...
    def from_dictionary(cls: Type, dictionary: Mapping[str, Any]) -> Optional[T]:
        ...
        backup_status = dictionary.get('backup_status')
        last_failed_policy_start_timestamp = dictionary.get('last_failed_policy_start_timestamp')
        last_successful_policy_start_timestamp = dictionary.get(
            'last_successful_policy_start_timestamp'
        )
        operation_info_list = None
        if dictionary.get('operation_info_list'):
            operation_info_list = list()
            for value in dictionary.get('operation_info_list'):
                operation_info_list.append(operation_info.OperationInfo.from_dictionary(value))
