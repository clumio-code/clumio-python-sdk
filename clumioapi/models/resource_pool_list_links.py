...
T = TypeVar('T', bound='ResourcePoolListLinks')


class ResourcePoolListLinks:
    """Implementation of the 'ResourcePoolListLinks' model.
    ...
    def __init__(
        ...
        """Constructor for the ResourcePoolListLinks class."""
