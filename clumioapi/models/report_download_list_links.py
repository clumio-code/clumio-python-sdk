...
T = TypeVar('T', bound='ReportDownloadListLinks')


class ReportDownloadListLinks:
    """Implementation of the 'ReportDownloadListLinks' model.
    ...
    def __init__(
        ...
        """Constructor for the ReportDownloadListLinks class."""
