...
from clumioapi.models import restore_ec2_links as restore_ec2_links_
...
class RestoreEC2Response:
    ...
    def __init__(
        ...
        links: restore_ec2_links_.RestoreEC2Links | None = None,
        ...
        self.links: restore_ec2_links_.RestoreEC2Links | None = links
    ...
    def from_dictionary(cls: Type[T], dictionary: Mapping[str, Any]) -> T:
        ...
        val_links = restore_ec2_links_.RestoreEC2Links.from_dictionary(val)
