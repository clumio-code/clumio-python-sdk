...
class EstimateCostS3InstantAccessEndpointAsyncResponseLinks:
    ...
    def __init__(
        ...
        cost_estimates_details_protection_group_instant_access_endpoint: object,
    ...
    def from_dictionary(cls: Type[T], dictionary: Mapping[str, Any]) -> T:
        ...
        val = dictionary['cost-estimates-details-protection-group-instant-access-endpoint']
        ...
        return cls(
            ...
            val_cost_estimates_details_protection_group_instant_access_endpoint,  # type: ignore
