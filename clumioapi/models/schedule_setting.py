...
class ScheduleSetting:
    ...
    def __init__(
        self, day_of_month: int, day_of_week: str, frequency: str, start_time: str, timezone: str
    ) -> None:
    ...
    def from_dictionary(cls: Type[T], dictionary: Mapping[str, Any]) -> T:
        ...
        val = dictionary['day_of_month']
        val_day_of_month = val

        val = dictionary['day_of_week']
        val_day_of_week = val

        val = dictionary['frequency']
        val_frequency = val
        ...
        return cls(
            val_day_of_month,  # type: ignore
            val_day_of_week,  # type: ignore
            val_frequency,  # type: ignore
