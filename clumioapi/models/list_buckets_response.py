...
class ListBucketsResponse:
    ...
    def __init__(
        self,
        embedded: bucket_list_embedded_.BucketListEmbedded,
        links: bucket_list_links_.BucketListLinks,
        current_count: int,
        limit: int,
        start: str,
        total_count: int,
        ...
        self.embedded: bucket_list_embedded_.BucketListEmbedded = embedded
        self.links: bucket_list_links_.BucketListLinks = links
    ...
    def from_dictionary(cls: Type[T], dictionary: Mapping[str, Any]) -> T:
        ...
        val_embedded = bucket_list_embedded_.BucketListEmbedded.from_dictionary(val)

        val = dictionary['_links']
        val_links = bucket_list_links_.BucketListLinks.from_dictionary(val)
