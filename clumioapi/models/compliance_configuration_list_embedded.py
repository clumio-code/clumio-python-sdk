...
from clumioapi.models import compliance_configuration
...
class ComplianceConfigurationListEmbedded:
    ...
    def __init__(
        self, items: Sequence[compliance_configuration.ComplianceConfiguration] = None
    ) -> None:
        """Constructor for the ComplianceConfigurationListEmbedded class."""

        # Initialize members of the class
        self.items: Sequence[compliance_configuration.ComplianceConfiguration] = items
    ...
    def from_dictionary(cls: Type, dictionary: Mapping[str, Any]) -> Optional[T]:
        ...
        if dictionary.get('items'):
            ...
            for value in dictionary.get('items'):
                items.append(
                    compliance_configuration.ComplianceConfiguration.from_dictionary(value)
                )
