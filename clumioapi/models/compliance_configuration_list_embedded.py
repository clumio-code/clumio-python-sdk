...
class ComplianceConfigurationListEmbedded:
    ...
    def __init__(self, items: Sequence[compliance_configuration_.ComplianceConfiguration]) -> None:
        """Constructor for the ComplianceConfigurationListEmbedded class."""

        # Initialize members of the class
        self.items: Sequence[compliance_configuration_.ComplianceConfiguration] = items
