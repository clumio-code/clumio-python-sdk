...
T = TypeVar('T', bound='RestoreProtectionGroupLinks')


class RestoreProtectionGroupLinks:
    """Implementation of the 'RestoreProtectionGroupLinks' model.
    ...
    def __init__(
        ...
        """Constructor for the RestoreProtectionGroupLinks class."""
