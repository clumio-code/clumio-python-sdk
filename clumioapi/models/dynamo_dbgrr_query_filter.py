...
class DynamoDBGRRQueryFilter:
    ...
    def __init__(
        self,
        attribute_filters: Sequence[dynamo_dbgrr_attribute_filter_.DynamoDBGRRAttributeFilter],
        partition_key: str,
        partition_key_filter: dynamo_db_key_filter_.DynamoDBKeyFilter,
        sort_key_filter: dynamo_db_key_filter_.DynamoDBKeyFilter,
    ) -> None:
        """Constructor for the DynamoDBGRRQueryFilter class."""

        # Initialize members of the class
        self.attribute_filters: Sequence[
            dynamo_dbgrr_attribute_filter_.DynamoDBGRRAttributeFilter
        ] = attribute_filters
        self.partition_key: str = partition_key
        self.partition_key_filter: dynamo_db_key_filter_.DynamoDBKeyFilter = partition_key_filter
        self.sort_key_filter: dynamo_db_key_filter_.DynamoDBKeyFilter = sort_key_filter
    ...
    def from_dictionary(cls: Type[T], dictionary: Mapping[str, Any]) -> T:
        ...
        val = dictionary['attribute_filters']
