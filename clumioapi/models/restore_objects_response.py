...
from clumioapi.models import restore_objects_links
...
class RestoreObjectsResponse:
    ...
    def __init__(
        ...
        links: restore_objects_links.RestoreObjectsLinks = None,
        task_id: str = None,
    ) -> None:
        ...
        self.links: restore_objects_links.RestoreObjectsLinks = links
    ...
    def from_dictionary(cls: Type, dictionary: Mapping[str, Any]) -> Optional[T]:
        ...
        key = '_links'
        links = (
            restore_objects_links.RestoreObjectsLinks.from_dictionary(dictionary.get(key))
            if dictionary.get(key)
            else None
        )
