...
T = TypeVar('T', bound='SetAssignmentsResponseLinks')


class SetAssignmentsResponseLinks:
    """Implementation of the 'SetAssignmentsResponseLinks' model.
    ...
    def __init__(
        ...
        """Constructor for the SetAssignmentsResponseLinks class."""
