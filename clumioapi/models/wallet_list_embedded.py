...
from clumioapi.models import wallet
...
class WalletListEmbedded:
    ...
    def __init__(self, items: Sequence[wallet.Wallet] = None) -> None:
        """Constructor for the WalletListEmbedded class."""

        # Initialize members of the class
        self.items: Sequence[wallet.Wallet] = items
    ...
    def from_dictionary(cls: Type, dictionary: Mapping[str, Any]) -> Optional[T]:
        ...
        if dictionary.get('items'):
            ...
            for value in dictionary.get('items'):
                items.append(wallet.Wallet.from_dictionary(value))
