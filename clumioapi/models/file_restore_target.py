...
class FileRestoreTarget:
    ...
    def __init__(
        ...
        email: email_download_data_access_option_.EmailDownloadDataAccessOption,
    ) -> None:
        """Constructor for the FileRestoreTarget class."""

        # Initialize members of the class
        self.direct_download: object = direct_download
        self.email: email_download_data_access_option_.EmailDownloadDataAccessOption = email
