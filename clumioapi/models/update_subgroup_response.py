...
T = TypeVar('T', bound='UpdateSubgroupResponse')


class UpdateSubgroupResponse:
    """Implementation of the 'UpdateSubgroupResponse' model.
    ...
    def __init__(
        ...
        """Constructor for the UpdateSubgroupResponse class."""
