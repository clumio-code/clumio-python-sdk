...
class ListComplianceConfigurationsResponse:
    ...
    def __init__(
        self,
        embedded: compliance_configuration_list_embedded_.ComplianceConfigurationListEmbedded,
        links: compliance_configuration_list_links_.ComplianceConfigurationListLinks,
        current_count: int,
        filter_applied: str,
        limit: int,
        start: str,
        ...
        self.embedded: (
            compliance_configuration_list_embedded_.ComplianceConfigurationListEmbedded
        ) = embedded
        self.links: compliance_configuration_list_links_.ComplianceConfigurationListLinks = links
