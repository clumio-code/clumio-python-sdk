...
T = TypeVar('T', bound='EBSBackupListLinksV1')


class EBSBackupListLinksV1:
    """Implementation of the 'EBSBackupListLinksV1' model.
    ...
    def __init__(
        ...
        """Constructor for the EBSBackupListLinksV1 class."""
