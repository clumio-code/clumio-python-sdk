...
T = TypeVar('T', bound='EntityGroupAssignmetUpdates')


class EntityGroupAssignmetUpdates:
    """Implementation of the 'EntityGroupAssignmetUpdates' model.
    ...
    def __init__(self, add: Sequence[str] = None, remove: Sequence[str] = None) -> None:
        """Constructor for the EntityGroupAssignmetUpdates class."""
