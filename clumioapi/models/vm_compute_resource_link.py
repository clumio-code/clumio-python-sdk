...
T = TypeVar('T', bound='VmComputeResourceLink')


class VmComputeResourceLink:
    """Implementation of the 'VmComputeResourceLink' model.
    ...
    def __init__(self, href: str = None, templated: bool = None, type: str = None) -> None:
        """Constructor for the VmComputeResourceLink class."""
