...
T = TypeVar('T', bound='ReadVCenterObjectProtectionStatsHateoasLink')


class ReadVCenterObjectProtectionStatsHateoasLink:
    """Implementation of the 'ReadVCenterObjectProtectionStatsHateoasLink' model.
    ...
    def __init__(self, href: str = None, templated: bool = None, p_type: str = None) -> None:
        """Constructor for the ReadVCenterObjectProtectionStatsHateoasLink class."""
