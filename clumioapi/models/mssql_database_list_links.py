...
T = TypeVar('T', bound='MssqlDatabaseListLinks')


class MssqlDatabaseListLinks:
    """Implementation of the 'MssqlDatabaseListLinks' model.
    ...
    def __init__(
        ...
        """Constructor for the MssqlDatabaseListLinks class."""
    ...
    def from_dictionary(cls: Type, dictionary: Mapping[str, Any]) -> Optional[T]:
        ...
        key = 'create-mssql-host-connections'
        create_mssql_host_connections = (
