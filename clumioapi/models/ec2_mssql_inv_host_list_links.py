...
T = TypeVar('T', bound='EC2MSSQLInvHostListLinks')


class EC2MSSQLInvHostListLinks:
    """Implementation of the 'EC2MSSQLInvHostListLinks' model.
    ...
    def __init__(
        ...
        """Constructor for the EC2MSSQLInvHostListLinks class."""
