...
T = TypeVar('T', bound='CreateBackupAwsIcebergTableV1Request')


@dataclasses.dataclass
class CreateBackupAwsIcebergTableV1Request:
    """Implementation of the 'CreateBackupAwsIcebergTableV1Request' model.
    ...
    Attributes:
        ...
        TableId:
            Performs the operation on the iceberg table with the specified clumio-assigned
            id.
