...
T = TypeVar('T', bound='RDSDatabaseTableListLinks')


class RDSDatabaseTableListLinks:
    """Implementation of the 'RDSDatabaseTableListLinks' model.
    ...
    def __init__(
        ...
        """Constructor for the RDSDatabaseTableListLinks class."""
