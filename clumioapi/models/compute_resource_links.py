...
T = TypeVar('T', bound='ComputeResourceLinks')


class ComputeResourceLinks:
    """Implementation of the 'ComputeResourceLinks' model.
    ...
    def __init__(
        ...
        read_vmware_vcenter_compute_resource_compliance_stats: read_v_center_object_protection_stats_hateoas_link.ReadVCenterObjectProtectionStatsHateoasLink = None,
        read_vmware_vcenter_compute_resource_connection_stats: hateoas_link.HateoasLink = None,
        unprotect_entities: unprotect_entities_hateoas_link.UnprotectEntitiesHateoasLink = None,
    ) -> None:
        """Constructor for the ComputeResourceLinks class."""
        ...
        self.read_vmware_vcenter_compute_resource_compliance_stats: read_v_center_object_protection_stats_hateoas_link.ReadVCenterObjectProtectionStatsHateoasLink = (
            read_vmware_vcenter_compute_resource_compliance_stats
        )
        self.read_vmware_vcenter_compute_resource_connection_stats: hateoas_link.HateoasLink = (
            read_vmware_vcenter_compute_resource_connection_stats
        )
    ...
    def from_dictionary(cls: Type, dictionary: Mapping[str, Any]) -> Optional[T]:
        ...
        key = 'read-vmware-vcenter-compute-resource-compliance-stats'
        read_vmware_vcenter_compute_resource_compliance_stats = (
        ...
        key = 'read-vmware-vcenter-compute-resource-connection-stats'
        read_vmware_vcenter_compute_resource_connection_stats = (
