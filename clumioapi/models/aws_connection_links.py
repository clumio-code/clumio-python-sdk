...
class AWSConnectionLinks:
    ...
    _names: dict[str, str] = {
        'p_self': '_self',
        'delete_connection_aws': 'delete-connection-aws',
    ...
    def __init__(
        ...
        delete_connection_aws: hateoas_link_.HateoasLink,
        ...
        self.delete_connection_aws: hateoas_link_.HateoasLink = delete_connection_aws
    ...
    def from_dictionary(cls: Type[T], dictionary: Mapping[str, Any]) -> T:
        ...
        val = dictionary['delete-connection-aws']
        ...
        return cls(
            ...
            val_delete_connection_aws,  # type: ignore
