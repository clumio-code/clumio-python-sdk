...
from clumioapi.models import restore_iceberg_table_links as restore_iceberg_table_links_
import requests

T = TypeVar('T', bound='RestoreAWSIcebergTableResponse')


@dataclasses.dataclass
class RestoreAWSIcebergTableResponse:
    """Implementation of the 'RestoreAWSIcebergTableResponse' model.
    ...
    Links: restore_iceberg_table_links_.RestoreIcebergTableLinks | None = None
    ...
    def from_dictionary(
        ...
        val_links = restore_iceberg_table_links_.RestoreIcebergTableLinks.from_dictionary(val)
