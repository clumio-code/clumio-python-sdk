...
T = TypeVar('T', bound='GCPGCSAssetContinuousBackupStatsLinks')


@dataclasses.dataclass
class GCPGCSAssetContinuousBackupStatsLinks:
    """Implementation of the 'GCPGCSAssetContinuousBackupStatsLinks' model.

    GCSAssetContinuousBackupStatsLinksURLs to pages related to the resource.
