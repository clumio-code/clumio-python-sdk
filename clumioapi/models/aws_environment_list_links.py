...
T = TypeVar('T', bound='AWSEnvironmentListLinks')


class AWSEnvironmentListLinks:
    """Implementation of the 'AWSEnvironmentListLinks' model.
    ...
    def __init__(
        ...
        """Constructor for the AWSEnvironmentListLinks class."""
