...
from clumioapi.models import v_mware_compute_resource_compliance_stats_links

T = TypeVar('T', bound='ReadVMwareComputeResourceStatsResponse')


class ReadVMwareComputeResourceStatsResponse:
    """Implementation of the 'ReadVMwareComputeResourceStatsResponse' model.
    ...
    def __init__(
        self,
        etag: str = None,
        links: v_mware_compute_resource_compliance_stats_links.VMwareComputeResourceComplianceStatsLinks = None,
        ...
        """Constructor for the ReadVMwareComputeResourceStatsResponse class."""
    ...
    def from_dictionary(cls: Type, dictionary: Mapping[str, Any]) -> Optional[T]:
        ...
        key = '_links'
        links = (
            v_mware_compute_resource_compliance_stats_links.VMwareComputeResourceComplianceStatsLinks.from_dictionary(
                dictionary.get(key)
            )
