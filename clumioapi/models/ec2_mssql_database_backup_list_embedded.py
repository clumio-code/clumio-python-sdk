...
class EC2MSSQLDatabaseBackupListEmbedded:
    ...
    def __init__(
        self, items: Sequence[ec2_mssql_database_backup_.EC2MSSQLDatabaseBackup] | None = None
    ) -> None:
        """Constructor for the EC2MSSQLDatabaseBackupListEmbedded class."""

        # Initialize members of the class
        self.items: Sequence[ec2_mssql_database_backup_.EC2MSSQLDatabaseBackup] | None = items
