...
T = TypeVar('T', bound='DiscoverTemplateInfo')


class DiscoverTemplateInfo:
    """Implementation of the 'DiscoverTemplateInfo' model.
    ...
    def __init__(
        ...
        """Constructor for the DiscoverTemplateInfo class."""
