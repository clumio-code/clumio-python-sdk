...
class AutoUserProvisioningRuleListLinks:
    ...
    def __init__(
        ...
        create_auto_user_provisioning_rule: hateoas_link_.HateoasLink | None = None,
    ) -> None:
        ...
        self.create_auto_user_provisioning_rule: hateoas_link_.HateoasLink | None = (
            create_auto_user_provisioning_rule
        )
    ...
    def from_dictionary(cls: Type[T], dictionary: Mapping[str, Any]) -> T:
        ...
        val = dictionary.get('create-auto-user-provisioning-rule', None)
        val_create_auto_user_provisioning_rule = hateoas_link_.HateoasLink.from_dictionary(val)
        ...
        return cls(
            ...
            val_p_next,
            val_p_self,
            val_create_auto_user_provisioning_rule,
        )
