...
class ConnectionGroupListLinks:
    ...
    def __init__(
        ...
        create_aws_connection: hateoas_link.HateoasLink = None,
        create_aws_connection_group: hateoas_link.HateoasLink = None,
    ) -> None:
        ...
        self.create_aws_connection: hateoas_link.HateoasLink = create_aws_connection
        self.create_aws_connection_group: hateoas_link.HateoasLink = create_aws_connection_group
    ...
    def from_dictionary(cls: Type, dictionary: Mapping[str, Any]) -> Optional[T]:
        ...
        key = 'create-aws-connection-group'
        create_aws_connection_group = (
            hateoas_link.HateoasLink.from_dictionary(dictionary.get(key))
            if dictionary.get(key)
            else None
        ...
        return cls(first, p_next, p_self, create_aws_connection, create_aws_connection_group)
