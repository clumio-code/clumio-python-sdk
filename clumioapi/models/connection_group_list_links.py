...
class ConnectionGroupListLinks:
    ...
    def __init__(
        ...
        create_aws_connection: hateoas_link_.HateoasLink,
        create_aws_connection_group: hateoas_link_.HateoasLink,
    ) -> None:
        ...
        self.create_aws_connection: hateoas_link_.HateoasLink = create_aws_connection
        self.create_aws_connection_group: hateoas_link_.HateoasLink = create_aws_connection_group
    ...
    def from_dictionary(cls: Type[T], dictionary: Mapping[str, Any]) -> T:
        ...
        val = dictionary['create-aws-connection']
        val_create_aws_connection = hateoas_link_.HateoasLink.from_dictionary(val)

        val = dictionary['create-aws-connection-group']
        ...
        return cls(
            ...
            val_create_aws_connection,  # type: ignore
            val_create_aws_connection_group,  # type: ignore
        )
