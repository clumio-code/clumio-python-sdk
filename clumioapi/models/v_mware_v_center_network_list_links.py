...
T = TypeVar('T', bound='VMwareVCenterNetworkListLinks')


class VMwareVCenterNetworkListLinks:
    """Implementation of the 'VMwareVCenterNetworkListLinks' model.
    ...
    def __init__(
        ...
        """Constructor for the VMwareVCenterNetworkListLinks class."""
