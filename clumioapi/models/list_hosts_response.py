...
from clumioapi.models import host_list_embedded, host_list_links

T = TypeVar('T', bound='ListHostsResponse')


class ListHostsResponse:
    """Implementation of the 'ListHostsResponse' model.
    ...
    def __init__(
        ...
        """Constructor for the ListHostsResponse class."""
