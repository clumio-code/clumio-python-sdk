...
T = TypeVar('T', bound='ProtectionGroupS3AssetBackupListLinks')


class ProtectionGroupS3AssetBackupListLinks:
    """Implementation of the 'ProtectionGroupS3AssetBackupListLinks' model.
    ...
    def __init__(
        ...
        """Constructor for the ProtectionGroupS3AssetBackupListLinks class."""

        # Initialize members of the class
        self.first: hateoas_first_link_.HateoasFirstLink | None = first
        self.last: hateoas_last_link_.HateoasLastLink | None = last
        self.p_next: hateoas_next_link_.HateoasNextLink | None = p_next
        self.prev: hateoas_prev_link_.HateoasPrevLink | None = prev
