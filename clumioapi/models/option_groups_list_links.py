...
T = TypeVar('T', bound='OptionGroupsListLinks')


class OptionGroupsListLinks:
    """Implementation of the 'OptionGroupsListLinks' model.
    ...
    def __init__(
        ...
        """Constructor for the OptionGroupsListLinks class."""
