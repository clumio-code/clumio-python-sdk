...
class EC2RestoreTarget:
    ...
    def __init__(
        self,
        ami_restore_target: ec2_ami_restore_target_.EC2AMIRestoreTarget,
        instance_restore_target: ec2_instance_restore_target_.EC2InstanceRestoreTarget,
        volumes_restore_target: ec2_volumes_restore_target_.EC2VolumesRestoreTarget,
    ) -> None:
        """Constructor for the EC2RestoreTarget class."""

        # Initialize members of the class
        self.ami_restore_target: ec2_ami_restore_target_.EC2AMIRestoreTarget = ami_restore_target
        self.instance_restore_target: ec2_instance_restore_target_.EC2InstanceRestoreTarget = (
            instance_restore_target
        )
        self.volumes_restore_target: ec2_volumes_restore_target_.EC2VolumesRestoreTarget = (
            volumes_restore_target
        )
    ...
    def from_dictionary(cls: Type[T], dictionary: Mapping[str, Any]) -> T:
        ...
        return cls(
            val_ami_restore_target,  # type: ignore
            val_instance_restore_target,  # type: ignore
            val_volumes_restore_target,  # type: ignore
        )
