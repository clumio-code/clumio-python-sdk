...
T = TypeVar('T', bound='MssqlRestoreTarget')


class MssqlRestoreTarget:
    """Implementation of the 'MssqlRestoreTarget' model.
    ...
    Attributes:
        ...
        instance_id:
            ...
            Use the [GET /datasources/mssql/instances](#operation/list-mssql-instances) to
            fetch valid values.
        log_files_path:
    ...
    def __init__(
        ...
        """Constructor for the MssqlRestoreTarget class."""
