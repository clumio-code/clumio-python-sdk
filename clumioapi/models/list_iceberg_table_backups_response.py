...
from clumioapi.models import \
    iceberg_table_backup_list_embedded as iceberg_table_backup_list_embedded_
from clumioapi.models import iceberg_table_backup_list_links as iceberg_table_backup_list_links_
import requests

T = TypeVar('T', bound='ListIcebergTableBackupsResponse')


@dataclasses.dataclass
class ListIcebergTableBackupsResponse:
    """Implementation of the 'ListIcebergTableBackupsResponse' model.
    ...
    Embedded: iceberg_table_backup_list_embedded_.IcebergTableBackupListEmbedded | None = None
    Links: iceberg_table_backup_list_links_.IcebergTableBackupListLinks | None = None
    ...
    def from_dictionary(
        ...
        val_embedded = (
            iceberg_table_backup_list_embedded_.IcebergTableBackupListEmbedded.from_dictionary(val)
        )

        val = dictionary.get('_links', None)
        val_links = iceberg_table_backup_list_links_.IcebergTableBackupListLinks.from_dictionary(
            val
        )
