...
class ListProtectionGroupBackupsResponse:
    ...
    def __init__(
        self,
        embedded: (
            protection_group_backup_list_embedded_.ProtectionGroupBackupListEmbedded | None
        ) = None,
        ...
        self.links: protection_group_backup_list_links_.ProtectionGroupBackupListLinks | None = (
            links
        )
