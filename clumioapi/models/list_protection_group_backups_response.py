...
class ListProtectionGroupBackupsResponse:
    ...
    def __init__(
        self,
        embedded: protection_group_backup_list_embedded_.ProtectionGroupBackupListEmbedded,
        links: protection_group_backup_list_links_.ProtectionGroupBackupListLinks,
        current_count: int,
        filter_applied: str,
        limit: int,
        start: str,
        ...
        self.embedded: protection_group_backup_list_embedded_.ProtectionGroupBackupListEmbedded = (
            embedded
        )
        self.links: protection_group_backup_list_links_.ProtectionGroupBackupListLinks = links
