...
class ListComplianceRunsResponse:
    ...
    def __init__(
        self,
        embedded: compliance_run_list_hateoas_embedded_.ComplianceRunListHateoasEmbedded,
        links: compliance_run_list_hateoas_links_.ComplianceRunListHateoasLinks,
        current_count: int,
        filter_applied: str,
        limit: int,
        start: str,
        ...
        self.embedded: compliance_run_list_hateoas_embedded_.ComplianceRunListHateoasEmbedded = (
            embedded
        )
        self.links: compliance_run_list_hateoas_links_.ComplianceRunListHateoasLinks = links
    ...
    def from_dictionary(cls: Type[T], dictionary: Mapping[str, Any]) -> T:
        ...
        val_embedded = (
            compliance_run_list_hateoas_embedded_.ComplianceRunListHateoasEmbedded.from_dictionary(
                val
            )
        )
        ...
        val_links = (
            compliance_run_list_hateoas_links_.ComplianceRunListHateoasLinks.from_dictionary(val)
        )
