...
T = TypeVar('T', bound='ProtectionGroupBackupListLinks')


class ProtectionGroupBackupListLinks:
    """Implementation of the 'ProtectionGroupBackupListLinks' model.
    ...
    def __init__(
        ...
        """Constructor for the ProtectionGroupBackupListLinks class."""
