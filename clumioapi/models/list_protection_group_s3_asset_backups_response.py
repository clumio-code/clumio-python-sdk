...
class ListProtectionGroupS3AssetBackupsResponse:
    ...
    def __init__(
        self,
        embedded: protection_group_s3_asset_backup_list_embedded_.ProtectionGroupS3AssetBackupListEmbedded,
        links: protection_group_s3_asset_backup_list_links_.ProtectionGroupS3AssetBackupListLinks,
        current_count: int,
        filter_applied: str,
        limit: int,
        start: str,
        ...
        self.links: (
            protection_group_s3_asset_backup_list_links_.ProtectionGroupS3AssetBackupListLinks
        ) = links
