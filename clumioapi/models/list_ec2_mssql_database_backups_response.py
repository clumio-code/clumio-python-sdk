...
from clumioapi.models import ec2_mssql_database_backup_list_embedded
from clumioapi.models import ec2_mssql_database_backup_list_links
...
class ListEC2MSSQLDatabaseBackupsResponse:
    ...
    def __init__(
        self,
        embedded: ec2_mssql_database_backup_list_embedded.EC2MSSQLDatabaseBackupListEmbedded = None,
        links: ec2_mssql_database_backup_list_links.EC2MSSQLDatabaseBackupListLinks = None,
    ...
    def from_dictionary(cls: Type, dictionary: Mapping[str, Any]) -> Optional[T]:
        ...
        key = '_embedded'
        embedded = (
            ec2_mssql_database_backup_list_embedded.EC2MSSQLDatabaseBackupListEmbedded.from_dictionary(
                dictionary.get(key)
            )
        ...
        key = '_links'
        links = (
            ec2_mssql_database_backup_list_links.EC2MSSQLDatabaseBackupListLinks.from_dictionary(
                dictionary.get(key)
            )
            if dictionary.get(key)
            else None
