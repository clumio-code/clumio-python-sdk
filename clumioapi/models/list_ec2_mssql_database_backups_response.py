...
class ListEC2MSSQLDatabaseBackupsResponse:
    ...
    def __init__(
        self,
        embedded: (
            ec2_mssql_database_backup_list_embedded_.EC2MSSQLDatabaseBackupListEmbedded | None
        ) = None,
        links: ec2_mssql_database_backup_list_links_.EC2MSSQLDatabaseBackupListLinks | None = None,
        ...
        self.links: ec2_mssql_database_backup_list_links_.EC2MSSQLDatabaseBackupListLinks | None = (
            links
        )
