...
from clumioapi.models import create_rds_database_restore_response_links
...
class CreateRdsResourceRestoreResponse:
    ...
    def __init__(
        ...
        links: create_rds_database_restore_response_links.CreateRdsDatabaseRestoreResponseLinks = None,
        task_id: str = None,
    ) -> None:
    ...
    def from_dictionary(cls: Type, dictionary: Mapping[str, Any]) -> Optional[T]:
        ...
        key = '_links'
        links = (
            create_rds_database_restore_response_links.CreateRdsDatabaseRestoreResponseLinks.from_dictionary(
                dictionary.get(key)
            )
            if dictionary.get(key)
            else None
