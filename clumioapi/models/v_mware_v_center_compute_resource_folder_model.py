...
T = TypeVar('T', bound='VMwareVCenterComputeResourceFolderModel')


class VMwareVCenterComputeResourceFolderModel:
    """Implementation of the 'VMwareVCenterComputeResourceFolderModel' model.
