...
T = TypeVar('T', bound='OrganizationalUnitWithETag')


class OrganizationalUnitWithETag:
    """Implementation of the 'OrganizationalUnitWithETag' model.
    ...
    def __init__(
        ...
        """Constructor for the OrganizationalUnitWithETag class."""
