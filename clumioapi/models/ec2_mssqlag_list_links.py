...
T = TypeVar('T', bound='EC2MSSQLAGListLinks')


class EC2MSSQLAGListLinks:
    """Implementation of the 'EC2MSSQLAGListLinks' model.
    ...
    def __init__(
        ...
        """Constructor for the EC2MSSQLAGListLinks class."""
