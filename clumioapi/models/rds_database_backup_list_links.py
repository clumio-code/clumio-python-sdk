...
T = TypeVar('T', bound='RdsDatabaseBackupListLinks')


class RdsDatabaseBackupListLinks:
    """Implementation of the 'RdsDatabaseBackupListLinks' model.
    ...
    def __init__(
        ...
        """Constructor for the RdsDatabaseBackupListLinks class."""
