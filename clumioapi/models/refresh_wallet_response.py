...
class RefreshWalletResponse:
    ...
    Attributes:
        ...
        clumio_control_plane_aws_account_id:
    ...
    _names = {
        ...
        'clumio_control_plane_aws_account_id': 'clumio_control_plane_aws_account_id',
    ...
    def __init__(
        ...
        clumio_control_plane_aws_account_id: str = None,
        ...
        """Constructor for the RefreshWalletResponse class."""
        ...
        self.clumio_control_plane_aws_account_id: str = clumio_control_plane_aws_account_id
    ...
    def from_dictionary(cls: Type, dictionary: Mapping[str, Any]) -> Optional[T]:
        ...
        clumio_control_plane_aws_account_id = dictionary.get('clumio_control_plane_aws_account_id')
