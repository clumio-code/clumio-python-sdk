...
T = TypeVar('T', bound='DatacenterEmbedded')


class DatacenterEmbedded:
    """Implementation of the 'DatacenterEmbedded' model.
    ...
    def __init__(
        ...
        self.read_vmware_vcenter_datacenter_compliance_stats: object = (
            read_vmware_vcenter_datacenter_compliance_stats
        )
    ...
    def from_dictionary(cls: Type, dictionary: Mapping[str, Any]) -> Optional[T]:
        ...
        read_vmware_vcenter_datacenter_compliance_stats = dictionary.get(
            'read-vmware-vcenter-datacenter-compliance-stats'
        )
        # Return an object of this model
        return cls(read_policy_definition, read_vmware_vcenter_datacenter_compliance_stats)
