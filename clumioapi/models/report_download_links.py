...
T = TypeVar('T', bound='ReportDownloadLinks')


class ReportDownloadLinks:
    """Implementation of the 'ReportDownloadLinks' model.
    ...
    def __init__(
        ...
        """Constructor for the ReportDownloadLinks class."""
