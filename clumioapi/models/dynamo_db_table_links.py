...
class DynamoDBTableLinks:
    ...
    _names: ClassVar[Dict[str, str]] = {
        'Self': '_self',
        'CreateBackupAwsDynamodbTable': 'create-backup-aws-dynamodb-table',
        'ListBackupAwsDynamodbTables': 'list-backup-aws-dynamodb-tables',
        'ReadPolicyDefinition': 'read-policy-definition',
        'RestoreAwsDynamodbTable': 'restore-aws-dynamodb-table',
    }
