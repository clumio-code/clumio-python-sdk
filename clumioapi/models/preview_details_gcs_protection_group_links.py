...
T = TypeVar('T', bound='PreviewDetailsGCSProtectionGroupLinks')


@dataclasses.dataclass
class PreviewDetailsGCSProtectionGroupLinks:
    """Implementation of the 'PreviewDetailsGCSProtectionGroupLinks' model.
