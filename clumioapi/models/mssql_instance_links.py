...
T = TypeVar('T', bound='MssqlInstanceLinks')


class MssqlInstanceLinks:
    """Implementation of the 'MssqlInstanceLinks' model.
    ...
    def __init__(
        ...
        get_mssql_instance_stats: hateoas_link.HateoasLink = None,
        ...
        """Constructor for the MssqlInstanceLinks class."""

        # Initialize members of the class
        self.p_self: hateoas_self_link.HateoasSelfLink = p_self
        self.get_mssql_instance_stats: hateoas_link.HateoasLink = get_mssql_instance_stats
