...
T = TypeVar('T', bound='ReadGCSProtectionGroupBackupResponse')


@dataclasses.dataclass
class ReadGCSProtectionGroupBackupResponse:
    """Implementation of the 'ReadGCSProtectionGroupBackupResponse' model.
