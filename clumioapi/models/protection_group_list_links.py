...
T = TypeVar('T', bound='ProtectionGroupListLinks')


class ProtectionGroupListLinks:
    """Implementation of the 'ProtectionGroupListLinks' model.
    ...
    def __init__(
        ...
        """Constructor for the ProtectionGroupListLinks class."""
