...
class ComplianceControls:
    ...
    def __init__(
        self,
        asset_backup: asset_backup_control_.AssetBackupControl,
        asset_protection: asset_protection_control_.AssetProtectionControl,
        policy: policy_control_.PolicyControl,
    ) -> None:
        """Constructor for the ComplianceControls class."""

        # Initialize members of the class
        self.asset_backup: asset_backup_control_.AssetBackupControl = asset_backup
        self.asset_protection: asset_protection_control_.AssetProtectionControl = asset_protection
        self.policy: policy_control_.PolicyControl = policy
