...
T = TypeVar('T', bound='ProtectEntitiesHateoasLink')


class ProtectEntitiesHateoasLink:
    """Implementation of the 'ProtectEntitiesHateoasLink' model.
    ...
    def __init__(
        ...
        """Constructor for the ProtectEntitiesHateoasLink class."""
