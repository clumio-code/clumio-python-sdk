...
T = TypeVar('T', bound='DynamoDBTableListLinks')


class DynamoDBTableListLinks:
    """Implementation of the 'DynamoDBTableListLinks' model.
    ...
    def __init__(
        ...
        """Constructor for the DynamoDBTableListLinks class."""
