...
T = TypeVar('T', bound='PreviewGCSProtectionGroupAsyncLinks')


@dataclasses.dataclass
class PreviewGCSProtectionGroupAsyncLinks:
    """Implementation of the 'PreviewGCSProtectionGroupAsyncLinks' model.
