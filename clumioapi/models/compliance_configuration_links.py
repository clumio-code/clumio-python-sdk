...
class ComplianceConfigurationLinks:
    ...
    _names: ClassVar[Dict[str, str]] = {
        'Self': '_self',
        'DeleteComplianceReportConfiguration': 'delete-compliance-report-configuration',
        'UpdateComplianceReportConfiguration': 'update-compliance-report-configuration',
    }
    ...
    def from_dictionary(
        ...
        val = dictionary.get('update-compliance-report-configuration', None)
