...
class ComplianceConfigurationLinks:
    ...
    def __init__(
        ...
        delete_compliance_report_configuration: hateoas_link_.HateoasLink,
        update_compliance_report_configuration: hateoas_link_.HateoasLink,
    ) -> None:
        """Constructor for the ComplianceConfigurationLinks class."""

        # Initialize members of the class
        self.p_self: hateoas_self_link_.HateoasSelfLink = p_self
        self.delete_compliance_report_configuration: hateoas_link_.HateoasLink = (
            delete_compliance_report_configuration
        )
        self.update_compliance_report_configuration: hateoas_link_.HateoasLink = (
            update_compliance_report_configuration
        )
    ...
    def from_dictionary(cls: Type[T], dictionary: Mapping[str, Any]) -> T:
        ...
        val = dictionary['delete-compliance-report-configuration']
        val_delete_compliance_report_configuration = hateoas_link_.HateoasLink.from_dictionary(val)

        val = dictionary['update-compliance-report-configuration']
        val_update_compliance_report_configuration = hateoas_link_.HateoasLink.from_dictionary(val)

        # Return an object of this model
        return cls(
            val_p_self,  # type: ignore
            val_delete_compliance_report_configuration,  # type: ignore
            val_update_compliance_report_configuration,  # type: ignore
        )
