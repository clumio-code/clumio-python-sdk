...
class ListTasksResponse:
    ...
    def __init__(
        self,
        embedded: task_list_embedded_.TaskListEmbedded,
        links: task_list_links_.TaskListLinks,
        current_count: int,
        filter_applied: str,
        limit: int,
        start: str,
        ...
        self.embedded: task_list_embedded_.TaskListEmbedded = embedded
        self.links: task_list_links_.TaskListLinks = links
