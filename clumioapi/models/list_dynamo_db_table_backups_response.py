...
class ListDynamoDBTableBackupsResponse:
    ...
    def __init__(
        self,
        embedded: dynamo_db_table_backup_list_embedded_.DynamoDBTableBackupListEmbedded,
        links: dynamo_db_table_backup_list_links_.DynamoDBTableBackupListLinks,
        current_count: int,
        filter_applied: str,
        limit: int,
        start: str,
        ...
        self.embedded: dynamo_db_table_backup_list_embedded_.DynamoDBTableBackupListEmbedded = (
            embedded
        )
        self.links: dynamo_db_table_backup_list_links_.DynamoDBTableBackupListLinks = links
