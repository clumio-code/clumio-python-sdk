...
from clumioapi.models import dynamo_db_table_backup_list_embedded
from clumioapi.models import dynamo_db_table_backup_list_links
...
class ListDynamoDBTableBackupsResponse:
    ...
    def __init__(
        self,
        embedded: dynamo_db_table_backup_list_embedded.DynamoDBTableBackupListEmbedded = None,
        links: dynamo_db_table_backup_list_links.DynamoDBTableBackupListLinks = None,
        ...
        self.embedded: dynamo_db_table_backup_list_embedded.DynamoDBTableBackupListEmbedded = (
            embedded
        )
        self.links: dynamo_db_table_backup_list_links.DynamoDBTableBackupListLinks = links
    ...
    def from_dictionary(cls: Type, dictionary: Mapping[str, Any]) -> Optional[T]:
        ...
        key = '_embedded'
        embedded = (
            dynamo_db_table_backup_list_embedded.DynamoDBTableBackupListEmbedded.from_dictionary(
                dictionary.get(key)
            )
        ...
        key = '_links'
        links = (
            dynamo_db_table_backup_list_links.DynamoDBTableBackupListLinks.from_dictionary(
                dictionary.get(key)
            )
            if dictionary.get(key)
            else None
