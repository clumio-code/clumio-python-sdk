...
from clumioapi.models import gcp_label_value_links as gcp_label_value_links_
import requests

T = TypeVar('T', bound='GCPLabelValue')


@dataclasses.dataclass
class GCPLabelValue:
    """Implementation of the 'GCPLabelValue' model.
    ...
    Links: gcp_label_value_links_.GCPLabelValueLinks | None = None
    CreatedTimestamp: str | None = None
    Id: str | None = None
    IsDeleted: bool | None = None
    KeyName: str | None = None
    LabelKeyId: str | None = None
    ...
    def from_dictionary(
        ...
        val_links = gcp_label_value_links_.GCPLabelValueLinks.from_dictionary(val)
        ...
        val = dictionary.get('key_name', None)
        val_key_name = val

        val = dictionary.get('label_key_id', None)
        val_label_key_id = val
