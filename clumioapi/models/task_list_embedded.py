...
from clumioapi.models import task
...
class TaskListEmbedded:
    ...
    def __init__(self, items: Sequence[task.Task] = None) -> None:
        """Constructor for the TaskListEmbedded class."""

        # Initialize members of the class
        self.items: Sequence[task.Task] = items
    ...
    def from_dictionary(cls: Type, dictionary: Mapping[str, Any]) -> Optional[T]:
        ...
        if dictionary.get('items'):
            ...
            for value in dictionary.get('items'):
                items.append(task.Task.from_dictionary(value))
