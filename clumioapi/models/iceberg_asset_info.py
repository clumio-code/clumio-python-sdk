...
T = TypeVar('T', bound='IcebergAssetInfo')


class IcebergAssetInfo:
    """Implementation of the 'IcebergAssetInfo' model.

    IcebergAssetInfoThe installed information for the Iceberg feature.
    ...
    def __init__(self, installed_template_version: str | None = None) -> None:
        """Constructor for the IcebergAssetInfo class."""
