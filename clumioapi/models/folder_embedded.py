...
T = TypeVar('T', bound='FolderEmbedded')


class FolderEmbedded:
    """Implementation of the 'FolderEmbedded' model.
    ...
    def __init__(
        ...
        read_vmware_vcenter_folder_compliance_stats: object = None,
    ) -> None:
        """Constructor for the FolderEmbedded class."""

        # Initialize members of the class
        self.read_policy_definition: object = read_policy_definition
        self.read_vmware_vcenter_folder_compliance_stats: object = (
            read_vmware_vcenter_folder_compliance_stats
        )
    ...
    def from_dictionary(cls: Type, dictionary: Mapping[str, Any]) -> Optional[T]:
        ...
        read_vmware_vcenter_folder_compliance_stats = dictionary.get(
            'read-vmware-vcenter-folder-compliance-stats'
        )
        # Return an object of this model
        return cls(read_policy_definition, read_vmware_vcenter_folder_compliance_stats)
