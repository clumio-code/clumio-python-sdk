...
T = TypeVar('T', bound='EC2BackupListLinks')


class EC2BackupListLinks:
    """Implementation of the 'EC2BackupListLinks' model.
    ...
    def __init__(
        ...
        """Constructor for the EC2BackupListLinks class."""
