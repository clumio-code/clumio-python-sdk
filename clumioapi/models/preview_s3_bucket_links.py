...
T = TypeVar('T', bound='PreviewS3BucketLinks')


class PreviewS3BucketLinks:
    """Implementation of the 'PreviewS3BucketLinks' model.
    ...
    def __init__(
        ...
        """Constructor for the PreviewS3BucketLinks class."""
