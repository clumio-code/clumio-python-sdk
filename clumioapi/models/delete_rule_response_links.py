...
T = TypeVar('T', bound='DeleteRuleResponseLinks')


class DeleteRuleResponseLinks:
    """Implementation of the 'DeleteRuleResponseLinks' model.
    ...
    def __init__(
        ...
        """Constructor for the DeleteRuleResponseLinks class."""
