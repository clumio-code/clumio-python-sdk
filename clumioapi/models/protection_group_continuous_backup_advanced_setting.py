...
class ProtectionGroupContinuousBackupAdvancedSetting:
    ...
    def __init__(self, disable_eventbridge_notification: bool) -> None:
    ...
    def from_dictionary(cls: Type[T], dictionary: Mapping[str, Any]) -> T:
        ...
        val = dictionary['disable_eventbridge_notification']
        val_disable_eventbridge_notification = val

        # Return an object of this model
        return cls(
            val_disable_eventbridge_notification,  # type: ignore
        )
