...
T = TypeVar('T', bound='MssqlDatabaseBackupListLinks')


class MssqlDatabaseBackupListLinks:
    """Implementation of the 'MssqlDatabaseBackupListLinks' model.
    ...
    def __init__(
        ...
        """Constructor for the MssqlDatabaseBackupListLinks class."""
