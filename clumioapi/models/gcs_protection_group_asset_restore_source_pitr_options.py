...
T = TypeVar('T', bound='GCSProtectionGroupAssetRestoreSourcePitrOptions')


@dataclasses.dataclass
class GCSProtectionGroupAssetRestoreSourcePitrOptions:
    """Implementation of the 'GCSProtectionGroupAssetRestoreSourcePitrOptions' model.
    ...
    Attributes:
        GcsAssetId:
            Clumio-assigned id of a gcs asset, representing the bucket within the
