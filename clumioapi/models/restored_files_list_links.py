...
T = TypeVar('T', bound='RestoredFilesListLinks')


class RestoredFilesListLinks:
    """Implementation of the 'RestoredFilesListLinks' model.
    ...
    def __init__(
        ...
        """Constructor for the RestoredFilesListLinks class."""
