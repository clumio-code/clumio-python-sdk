...
class AWSEnvironmentEmbedded:
    ...
    def __init__(self,
        read_aws_environment_ebs_volumes_compliance_stats:  = None
    ) -> None:
    ...
    def from_dictionary(
        ...
        read_aws_environment_ebs_volumes_compliance_stats = dictionary.get('read-aws-environment-ebs-volumes-compliance-stats')
