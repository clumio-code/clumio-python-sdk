...
T = TypeVar('T', bound='GCSProtectionGroupAssetBackupListLinks')


@dataclasses.dataclass
class GCSProtectionGroupAssetBackupListLinks:
    """Implementation of the 'GCSProtectionGroupAssetBackupListLinks' model.
