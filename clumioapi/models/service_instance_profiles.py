...
class ServiceInstanceProfiles:
    ...
    def __init__(
        self, mssql: mssql_service_instance_profiles_.MssqlServiceInstanceProfiles
    ) -> None:
        """Constructor for the ServiceInstanceProfiles class."""

        # Initialize members of the class
        self.mssql: mssql_service_instance_profiles_.MssqlServiceInstanceProfiles = mssql
