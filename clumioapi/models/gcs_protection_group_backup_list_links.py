...
T = TypeVar('T', bound='GCSProtectionGroupBackupListLinks')


@dataclasses.dataclass
class GCSProtectionGroupBackupListLinks:
    """Implementation of the 'GCSProtectionGroupBackupListLinks' model.
