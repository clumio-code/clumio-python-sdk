...
class S3BucketSizeRes:
    ...
    Attributes:
        ...
        deep_archive_s_3_object_overhead:
            Size of Deep Archive S3 Object Overhead in bytes.
        deep_archive_s_3_object_overhead_retrieved_time:
        ...
        glacier_s_3_object_overhead:
            Size of Glacier S3 Object Overhead in bytes.
        glacier_s_3_object_overhead_retrieved_time:
    ...
    _names = {
        ...
        'deep_archive_s_3_object_overhead': 'deep_archive_s_3_object_overhead',
        'deep_archive_s_3_object_overhead_retrieved_time': 'deep_archive_s_3_object_overhead_retrieved_time',
        ...
        'glacier_s_3_object_overhead': 'glacier_s_3_object_overhead',
        'glacier_s_3_object_overhead_retrieved_time': 'glacier_s_3_object_overhead_retrieved_time',
    ...
    def __init__(
        ...
        deep_archive_s_3_object_overhead: int = None,
        deep_archive_s_3_object_overhead_retrieved_time: str = None,
        ...
        glacier_s_3_object_overhead: int = None,
        glacier_s_3_object_overhead_retrieved_time: str = None,
        ...
        self.deep_archive_s_3_object_overhead: int = deep_archive_s_3_object_overhead
        self.deep_archive_s_3_object_overhead_retrieved_time: str = (
            deep_archive_s_3_object_overhead_retrieved_time
        )
        ...
        self.glacier_s_3_object_overhead: int = glacier_s_3_object_overhead
        self.glacier_s_3_object_overhead_retrieved_time: str = (
            glacier_s_3_object_overhead_retrieved_time
        )
    ...
    def from_dictionary(cls: Type, dictionary: Mapping[str, Any]) -> Optional[T]:
        ...
        deep_archive_s_3_object_overhead = dictionary.get('deep_archive_s_3_object_overhead')
        deep_archive_s_3_object_overhead_retrieved_time = dictionary.get(
            'deep_archive_s_3_object_overhead_retrieved_time'
        )
        ...
        glacier_s_3_object_overhead = dictionary.get('glacier_s_3_object_overhead')
        glacier_s_3_object_overhead_retrieved_time = dictionary.get(
            'glacier_s_3_object_overhead_retrieved_time'
        )
