...
T = TypeVar('T', bound='DeleteHostResponseLinks')


class DeleteHostResponseLinks:
    """Implementation of the 'DeleteHostResponseLinks' model.
    ...
    def __init__(
        ...
        """Constructor for the DeleteHostResponseLinks class."""
