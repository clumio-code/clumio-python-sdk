...
T = TypeVar('T', bound='ConsolidatedAlertListLinks')


class ConsolidatedAlertListLinks:
    """Implementation of the 'ConsolidatedAlertListLinks' model.
    ...
    def __init__(
        ...
        """Constructor for the ConsolidatedAlertListLinks class."""
