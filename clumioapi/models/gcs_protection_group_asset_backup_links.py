...
T = TypeVar('T', bound='GCSProtectionGroupAssetBackupLinks')


@dataclasses.dataclass
class GCSProtectionGroupAssetBackupLinks:
    """Implementation of the 'GCSProtectionGroupAssetBackupLinks' model.
