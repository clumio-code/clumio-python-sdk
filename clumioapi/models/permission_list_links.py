...
T = TypeVar('T', bound='PermissionListLinks')


class PermissionListLinks:
    """Implementation of the 'PermissionListLinks' model.
    ...
    def __init__(
        ...
        """Constructor for the PermissionListLinks class."""
