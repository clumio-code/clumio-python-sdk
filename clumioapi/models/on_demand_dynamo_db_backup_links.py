...
T = TypeVar('T', bound='OnDemandDynamoDBBackupLinks')


class OnDemandDynamoDBBackupLinks:
    """Implementation of the 'OnDemandDynamoDBBackupLinks' model.
    ...
    def __init__(
        ...
        """Constructor for the OnDemandDynamoDBBackupLinks class."""
