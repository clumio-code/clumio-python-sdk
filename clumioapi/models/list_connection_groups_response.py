...
class ListConnectionGroupsResponse:
    ...
    def __init__(
        self,
        embedded: aws_connection_group_list_embedded_.AWSConnectionGroupListEmbedded,
        links: connection_group_list_links_.ConnectionGroupListLinks,
        current_count: int,
        filter_applied: str,
        limit: int,
        start: str,
        ...
        self.embedded: aws_connection_group_list_embedded_.AWSConnectionGroupListEmbedded = embedded
        self.links: connection_group_list_links_.ConnectionGroupListLinks = links
