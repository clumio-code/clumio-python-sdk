...
T = TypeVar('T', bound='ProtectionGroupBucketListLinks')


class ProtectionGroupBucketListLinks:
    """Implementation of the 'ProtectionGroupBucketListLinks' model.
    ...
    def __init__(
        ...
        """Constructor for the ProtectionGroupBucketListLinks class."""
