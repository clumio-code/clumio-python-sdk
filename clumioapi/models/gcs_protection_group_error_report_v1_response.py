...
T = TypeVar('T', bound='GcsProtectionGroupErrorReportV1Response')


@dataclasses.dataclass
class GcsProtectionGroupErrorReportV1Response:
    """Implementation of the 'GcsProtectionGroupErrorReportV1Response' model.
