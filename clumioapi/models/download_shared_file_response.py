...
class DownloadSharedFileResponse:
    ...
    def __init__(
        self, links: download_shared_file_links_.DownloadSharedFileLinks, download_url: str
    ) -> None:
        """Constructor for the DownloadSharedFileResponse class."""

        # Initialize members of the class
        self.links: download_shared_file_links_.DownloadSharedFileLinks = links
    ...
    def from_dictionary(cls: Type[T], dictionary: Mapping[str, Any]) -> T:
        ...
        val = dictionary['download_url']
        val_download_url = val

        # Return an object of this model
        return cls(
            val_links,  # type: ignore
            val_download_url,  # type: ignore
        )
