...
class RestoreProtectionGroupS3AssetResponse:
    ...
    def __init__(
        ...
        links: restore_protection_group_s3_asset_links_.RestoreProtectionGroupS3AssetLinks,
        task_id: str,
    ) -> None:
        ...
        self.links: restore_protection_group_s3_asset_links_.RestoreProtectionGroupS3AssetLinks = (
            links
        )
