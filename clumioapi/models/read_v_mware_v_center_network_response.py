...
class ReadVMwareVCenterNetworkResponse:
    """Implementation of the 'ReadVMwareVCenterNetworkResponse' model.
    ...
    def __init__(
        ...
        """Constructor for the ReadVMwareVCenterNetworkResponse class."""
