...
class ListEC2MssqlDatabasePitrIntervalsResponse:
    ...
    def __init__(
        self,
        embedded: ec2_mssql_database_pitr_interval_list_embedded_.EC2MssqlDatabasePitrIntervalListEmbedded,
        links: ec2_mssql_database_pitr_interval_list_links_.EC2MssqlDatabasePitrIntervalListLinks,
        current_count: int,
        filter_applied: str,
        limit: int,
        start: str,
