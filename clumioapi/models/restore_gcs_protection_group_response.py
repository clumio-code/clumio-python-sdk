...
from clumioapi.models import \
    restore_gcs_protection_group_links as restore_gcs_protection_group_links_
import requests

T = TypeVar('T', bound='RestoreGCSProtectionGroupResponse')


@dataclasses.dataclass
class RestoreGCSProtectionGroupResponse:
    """Implementation of the 'RestoreGCSProtectionGroupResponse' model.
    ...
    Links: restore_gcs_protection_group_links_.RestoreGCSProtectionGroupLinks | None = None
    ...
    def from_dictionary(
        ...
        val_links = (
            restore_gcs_protection_group_links_.RestoreGCSProtectionGroupLinks.from_dictionary(val)
        )
