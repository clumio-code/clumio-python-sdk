...
T = TypeVar('T', bound='PreviewGCSProtectionGroupAssetDetailsLinks')


@dataclasses.dataclass
class PreviewGCSProtectionGroupAssetDetailsLinks:
    """Implementation of the 'PreviewGCSProtectionGroupAssetDetailsLinks' model.
