...
T = TypeVar('T', bound='CreateOnDemandMSSQLDatabaseBackupResponseLinks')


class CreateOnDemandMSSQLDatabaseBackupResponseLinks:
    """Implementation of the 'CreateOnDemandMSSQLDatabaseBackupResponseLinks' model.
    ...
    def __init__(
        ...
        """Constructor for the CreateOnDemandMSSQLDatabaseBackupResponseLinks class."""
