...
T = TypeVar('T', bound='ConnectionGroupLinks')


@dataclasses.dataclass
class ConnectionGroupLinks:
    """Implementation of the 'ConnectionGroupLinks' model.
    ...
    _names: ClassVar[Dict[str, str]] = {
        ...
        'UpdateAwsConnectionGroup': 'update-aws-connection-group',
    }

    Self: hateoas_self_link_.HateoasSelfLink | None = None
    ReadOrganizationalUnit: hateoas_link_.HateoasLink | None = None
    UpdateAwsConnectionGroup: hateoas_link_.HateoasLink | None = None
    ...
    def from_dictionary(
        ...
        val = dictionary.get('update-aws-connection-group', None)
        val_update_aws_connection_group = hateoas_link_.HateoasLink.from_dictionary(val)

        # Return an object of this model
        return cls(
            val_self,
            val_read_organizational_unit,
            val_update_aws_connection_group,
        )
