...
T = TypeVar('T', bound='EC2MSSQLDatabaseListLinks')


class EC2MSSQLDatabaseListLinks:
    """Implementation of the 'EC2MSSQLDatabaseListLinks' model.
    ...
    def __init__(
        ...
        """Constructor for the EC2MSSQLDatabaseListLinks class."""
