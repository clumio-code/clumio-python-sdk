...
T = TypeVar('T', bound='OnDemandAWSIcebergTableBackupLinks')


@dataclasses.dataclass
class OnDemandAWSIcebergTableBackupLinks:
    """Implementation of the 'OnDemandAWSIcebergTableBackupLinks' model.
