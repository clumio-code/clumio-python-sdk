...
T = TypeVar('T', bound='RestoreRecordsLinksAsync')


class RestoreRecordsLinksAsync:
    """Implementation of the 'RestoreRecordsLinksAsync' model.
    ...
    def __init__(
        ...
        """Constructor for the RestoreRecordsLinksAsync class."""
