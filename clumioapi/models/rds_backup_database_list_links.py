...
T = TypeVar('T', bound='RDSBackupDatabaseListLinks')


class RDSBackupDatabaseListLinks:
    """Implementation of the 'RDSBackupDatabaseListLinks' model.
    ...
    def __init__(
        ...
        """Constructor for the RDSBackupDatabaseListLinks class."""
