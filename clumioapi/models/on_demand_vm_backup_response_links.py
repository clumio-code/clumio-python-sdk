...
T = TypeVar('T', bound='OnDemandVMBackupResponseLinks')


class OnDemandVMBackupResponseLinks:
    """Implementation of the 'OnDemandVMBackupResponseLinks' model.
    ...
    def __init__(
        ...
        """Constructor for the OnDemandVMBackupResponseLinks class."""
