...
T = TypeVar('T', bound='AWSConnectionConfigModel')


class AWSConnectionConfigModel:
    """Implementation of the 'AWSConnectionConfigModel' model.
    ...
    def __init__(self, protect: protect_template_config.ProtectTemplateConfig = None) -> None:
        """Constructor for the AWSConnectionConfigModel class."""
