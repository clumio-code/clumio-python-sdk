...
class ListEC2MssqlAGsResponse:
    ...
    def __init__(
        self,
        embedded: ec2_mssqlag_list_embedded_.EC2MSSQLAGListEmbedded,
        links: ec2_mssqlag_list_links_.EC2MSSQLAGListLinks,
        current_count: int,
        filter_applied: str,
        limit: int,
        start: str,
        ...
        self.embedded: ec2_mssqlag_list_embedded_.EC2MSSQLAGListEmbedded = embedded
        self.links: ec2_mssqlag_list_links_.EC2MSSQLAGListLinks = links
