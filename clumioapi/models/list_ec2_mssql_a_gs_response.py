...
from clumioapi.models import ec2_mssqlag_list_embedded
from clumioapi.models import ec2_mssqlag_list_links
...
class ListEC2MssqlAGsResponse:
    ...
    def __init__(
        self,
        embedded: ec2_mssqlag_list_embedded.EC2MSSQLAGListEmbedded = None,
        links: ec2_mssqlag_list_links.EC2MSSQLAGListLinks = None,
        ...
        """Constructor for the ListEC2MssqlAGsResponse class."""

        # Initialize members of the class
        self.embedded: ec2_mssqlag_list_embedded.EC2MSSQLAGListEmbedded = embedded
        self.links: ec2_mssqlag_list_links.EC2MSSQLAGListLinks = links
    ...
    def from_dictionary(cls: Type, dictionary: Mapping[str, Any]) -> Optional[T]:
        ...
        key = '_embedded'
        embedded = (
            ec2_mssqlag_list_embedded.EC2MSSQLAGListEmbedded.from_dictionary(dictionary.get(key))
        ...
        key = '_links'
        links = (
            ec2_mssqlag_list_links.EC2MSSQLAGListLinks.from_dictionary(dictionary.get(key))
            if dictionary.get(key)
            else None
        )
