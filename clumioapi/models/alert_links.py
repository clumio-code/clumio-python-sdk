...
class AlertLinks:
    ...
    _names: ClassVar[Dict[str, str]] = {
        'Self': '_self',
        'ReadConsolidatedAlert': 'read-consolidated-alert',
        'UpdateIndividualAlert': 'update-individual-alert',
    }

    Self: hateoas_self_link_.HateoasSelfLink | None = None
    ReadConsolidatedAlert: hateoas_link_.HateoasLink | None = None
    UpdateIndividualAlert: hateoas_link_.HateoasLink | None = None
