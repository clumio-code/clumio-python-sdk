...
T = TypeVar('T', bound='VMwareDatastoreListLinks')


class VMwareDatastoreListLinks:
    """Implementation of the 'VMwareDatastoreListLinks' model.
    ...
    def __init__(
        ...
        """Constructor for the VMwareDatastoreListLinks class."""
