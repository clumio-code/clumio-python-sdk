...
class RuleListLinks:
    ...
    def __init__(
        ...
        create_policy_rule: hateoas_link_.HateoasLink,
    ) -> None:
        ...
        self.create_policy_rule: hateoas_link_.HateoasLink = create_policy_rule
    ...
    def from_dictionary(cls: Type[T], dictionary: Mapping[str, Any]) -> T:
        ...
        val = dictionary['create-policy-rule']
        ...
        return cls(
            ...
            val_create_policy_rule,  # type: ignore
        )
