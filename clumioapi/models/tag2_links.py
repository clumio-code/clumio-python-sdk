...
T = TypeVar('T', bound='Tag2Links')


class Tag2Links:
    """Implementation of the 'Tag2Links' model.
    ...
    def __init__(
        ...
        read_vmware_vcenter_tag_compliance_stats: read_v_center_object_protection_stats_hateoas_link.ReadVCenterObjectProtectionStatsHateoasLink = None,
        unprotect_entities: unprotect_entities_hateoas_link.UnprotectEntitiesHateoasLink = None,
    ) -> None:
        """Constructor for the Tag2Links class."""
        ...
        self.read_vmware_vcenter_tag_compliance_stats: read_v_center_object_protection_stats_hateoas_link.ReadVCenterObjectProtectionStatsHateoasLink = (
            read_vmware_vcenter_tag_compliance_stats
        )
    ...
    def from_dictionary(cls: Type, dictionary: Mapping[str, Any]) -> Optional[T]:
        ...
        key = 'read-vmware-vcenter-tag-compliance-stats'
        read_vmware_vcenter_tag_compliance_stats = (
