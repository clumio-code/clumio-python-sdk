...
T = TypeVar('T', bound='RestoreS3BucketLinks')


class RestoreS3BucketLinks:
    """Implementation of the 'RestoreS3BucketLinks' model.
    ...
    def __init__(
        ...
        """Constructor for the RestoreS3BucketLinks class."""
