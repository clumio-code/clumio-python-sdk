...
class FileSearchResponse:
    ...
    def __init__(
        self,
        embedded: file_search_list_embedded_.FileSearchListEmbedded,
        links: file_search_list_links_.FileSearchListLinks,
        current_count: int,
        limit: int,
        start: str,
    ) -> None:
        ...
        self.embedded: file_search_list_embedded_.FileSearchListEmbedded = embedded
        self.links: file_search_list_links_.FileSearchListLinks = links
