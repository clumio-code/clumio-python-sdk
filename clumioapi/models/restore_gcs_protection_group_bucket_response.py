...
from clumioapi.models import \
    restore_gcs_protection_group_bucket_links as restore_gcs_protection_group_bucket_links_
import requests

T = TypeVar('T', bound='RestoreGCSProtectionGroupBucketResponse')


@dataclasses.dataclass
class RestoreGCSProtectionGroupBucketResponse:
    """Implementation of the 'RestoreGCSProtectionGroupBucketResponse' model.
    ...
    Attributes:
        ...
        Links:
            Restoregcsprotectiongroupbucketlinks contains hateoas links for a gcs bucket
            restore response.
    ...
    Links: (
        restore_gcs_protection_group_bucket_links_.RestoreGCSProtectionGroupBucketLinks | None
    ) = None
    ...
    def from_dictionary(
        ...
        val_links = restore_gcs_protection_group_bucket_links_.RestoreGCSProtectionGroupBucketLinks.from_dictionary(
            val
        )
