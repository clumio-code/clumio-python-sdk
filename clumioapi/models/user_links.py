...
class UserLinks:
    ...
    def __init__(
        ...
        delete_user: hateoas_link_.HateoasLink | None = None,
        update_user: hateoas_link_.HateoasLink | None = None,
    ) -> None:
        """Constructor for the UserLinks class."""

        # Initialize members of the class
        self.p_self: hateoas_self_link_.HateoasSelfLink | None = p_self
        self.delete_user: hateoas_link_.HateoasLink | None = delete_user
        self.update_user: hateoas_link_.HateoasLink | None = update_user
    ...
    def from_dictionary(cls: Type[T], dictionary: Mapping[str, Any]) -> T:
        ...
        val = dictionary.get('delete-user', None)
        val_delete_user = hateoas_link_.HateoasLink.from_dictionary(val)

        val = dictionary.get('update-user', None)
