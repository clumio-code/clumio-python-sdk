...
class Error:
    ...
    def __init__(self, errors: Sequence[single_error_response_.SingleErrorResponse]) -> None:
        """Constructor for the Error class."""

        # Initialize members of the class
        self.errors: Sequence[single_error_response_.SingleErrorResponse] = errors
