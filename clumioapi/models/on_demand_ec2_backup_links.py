...
T = TypeVar('T', bound='OnDemandEC2BackupLinks')


class OnDemandEC2BackupLinks:
    """Implementation of the 'OnDemandEC2BackupLinks' model.
    ...
    def __init__(
        ...
        """Constructor for the OnDemandEC2BackupLinks class."""
