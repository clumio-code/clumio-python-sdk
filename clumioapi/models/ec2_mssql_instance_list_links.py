...
T = TypeVar('T', bound='EC2MSSQLInstanceListLinks')


class EC2MSSQLInstanceListLinks:
    """Implementation of the 'EC2MSSQLInstanceListLinks' model.
    ...
    def __init__(
        ...
        """Constructor for the EC2MSSQLInstanceListLinks class."""
