...
T = TypeVar('T', bound='UpdateRuleResponseLinks')


class UpdateRuleResponseLinks:
    """Implementation of the 'UpdateRuleResponseLinks' model.
    ...
    def __init__(
        ...
        """Constructor for the UpdateRuleResponseLinks class."""
