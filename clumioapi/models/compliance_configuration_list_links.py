...
class ComplianceConfigurationListLinks:
    ...
    def __init__(
        ...
        create_compliance_report_configuration: hateoas_link.HateoasLink = None,
    ) -> None:
        ...
        self.create_compliance_report_configuration: hateoas_link.HateoasLink = (
            create_compliance_report_configuration
        )
    ...
    def from_dictionary(cls: Type, dictionary: Mapping[str, Any]) -> Optional[T]:
        ...
        key = 'create-compliance-report-configuration'
        create_compliance_report_configuration = (
        ...
        return cls(first, p_next, p_self, create_compliance_report_configuration)
