...
class ListReportDownloadsResponse:
    ...
    def __init__(
        ...
        self.embedded: report_download_list_embedded_.ReportDownloadListEmbedded | None = embedded
        self.links: report_download_list_links_.ReportDownloadListLinks | None = links
