...
T = TypeVar('T', bound='ReadOrganizationalUnitResponse')


class ReadOrganizationalUnitResponse:
    """Implementation of the 'ReadOrganizationalUnitResponse' model.
    ...
    def __init__(
        ...
        """Constructor for the ReadOrganizationalUnitResponse class."""
