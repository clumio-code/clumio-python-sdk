...
class ListConsolidatedAlertsResponse:
    ...
    def __init__(
        ...
        self.embedded: consolidated_alert_list_embedded_.ConsolidatedAlertListEmbedded | None = (
            embedded
        )
        self.links: consolidated_alert_list_links_.ConsolidatedAlertListLinks | None = links
