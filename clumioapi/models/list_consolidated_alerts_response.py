...
class ListConsolidatedAlertsResponse:
    ...
    def __init__(
        self,
        embedded: consolidated_alert_list_embedded_.ConsolidatedAlertListEmbedded,
        links: consolidated_alert_list_links_.ConsolidatedAlertListLinks,
        current_count: int,
        filter_applied: str,
        limit: int,
        start: str,
        ...
        self.embedded: consolidated_alert_list_embedded_.ConsolidatedAlertListEmbedded = embedded
        self.links: consolidated_alert_list_links_.ConsolidatedAlertListLinks = links
    ...
    def from_dictionary(cls: Type[T], dictionary: Mapping[str, Any]) -> T:
        ...
        val_embedded = (
            consolidated_alert_list_embedded_.ConsolidatedAlertListEmbedded.from_dictionary(val)
        )

        val = dictionary['_links']
        val_links = consolidated_alert_list_links_.ConsolidatedAlertListLinks.from_dictionary(val)
