...
T = TypeVar('T', bound='ReadGCSProtectionGroupAssetBackupResponse')


@dataclasses.dataclass
class ReadGCSProtectionGroupAssetBackupResponse:
    """Implementation of the 'ReadGCSProtectionGroupAssetBackupResponse' model.
