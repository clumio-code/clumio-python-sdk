...
T = TypeVar('T', bound='RestoreDynamoDBTableLinks')


class RestoreDynamoDBTableLinks:
    """Implementation of the 'RestoreDynamoDBTableLinks' model.
    ...
    def __init__(
        ...
        """Constructor for the RestoreDynamoDBTableLinks class."""
