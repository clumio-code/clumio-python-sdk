...
class RestoreAwsS3BucketV1Request:
    ...
    def __init__(
        self,
        source: restore_s3_bucket_source_.RestoreS3BucketSource,
        target: restore_s3_bucket_target_.RestoreS3BucketTarget,
        p_type: str,
    ) -> None:
        """Constructor for the RestoreAwsS3BucketV1Request class."""

        # Initialize members of the class
        self.source: restore_s3_bucket_source_.RestoreS3BucketSource = source
        self.target: restore_s3_bucket_target_.RestoreS3BucketTarget = target
