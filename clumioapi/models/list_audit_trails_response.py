...
from clumioapi.models import audit_trail_list_embedded as audit_trail_list_embedded_
from clumioapi.models import audit_trail_list_links as audit_trail_list_links_

T = TypeVar('T', bound='ListAuditTrailsResponse')


class ListAuditTrailsResponse:
    """Implementation of the 'ListAuditTrailsResponse' model.
    ...
    def __init__(
        self,
        embedded: audit_trail_list_embedded_.AuditTrailListEmbedded | None = None,
        links: audit_trail_list_links_.AuditTrailListLinks | None = None,
        ...
        """Constructor for the ListAuditTrailsResponse class."""

        # Initialize members of the class
        self.embedded: audit_trail_list_embedded_.AuditTrailListEmbedded | None = embedded
        self.links: audit_trail_list_links_.AuditTrailListLinks | None = links
    ...
    def from_dictionary(cls: Type[T], dictionary: Mapping[str, Any]) -> T:
        ...
        val_embedded = audit_trail_list_embedded_.AuditTrailListEmbedded.from_dictionary(val)

        val = dictionary.get('_links', None)
        val_links = audit_trail_list_links_.AuditTrailListLinks.from_dictionary(val)
