...
class ListAuditTrailsResponse:
    ...
    def __init__(
        self,
        embedded: audit_trail_list_embedded.AuditTrailListEmbedded = None,
        links: audit_trail_list_links.AuditTrailListLinks = None,
        ...
        self.embedded: audit_trail_list_embedded.AuditTrailListEmbedded = embedded
        self.links: audit_trail_list_links.AuditTrailListLinks = links
    ...
    def from_dictionary(cls: Type, dictionary: Mapping[str, Any]) -> Optional[T]:
        ...
        key = '_embedded'
        embedded = (
            audit_trail_list_embedded.AuditTrailListEmbedded.from_dictionary(dictionary.get(key))
        ...
        key = '_links'
        links = (
            audit_trail_list_links.AuditTrailListLinks.from_dictionary(dictionary.get(key))
            if dictionary.get(key)
            else None
        )
