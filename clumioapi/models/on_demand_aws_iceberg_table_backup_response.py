...
from clumioapi.models import \
    on_demand_aws_iceberg_table_backup_links as on_demand_aws_iceberg_table_backup_links_
from clumioapi.models import read_task_hateoas_outer_embedded as read_task_hateoas_outer_embedded_
import requests

T = TypeVar('T', bound='OnDemandAWSIcebergTableBackupResponse')


@dataclasses.dataclass
class OnDemandAWSIcebergTableBackupResponse:
    """Implementation of the 'OnDemandAWSIcebergTableBackupResponse' model.
    ...
    Links: on_demand_aws_iceberg_table_backup_links_.OnDemandAWSIcebergTableBackupLinks | None = (
        None
    )
    ...
    def from_dictionary(
        ...
        val_links = on_demand_aws_iceberg_table_backup_links_.OnDemandAWSIcebergTableBackupLinks.from_dictionary(
            val
        )
