...
T = TypeVar('T', bound='PreviewGCSProtectionGroupAssetAsyncLinks')


@dataclasses.dataclass
class PreviewGCSProtectionGroupAssetAsyncLinks:
    """Implementation of the 'PreviewGCSProtectionGroupAssetAsyncLinks' model.
