...
class ClumioRoleResource:
    """Implementation of the 'ClumioRoleResource' model.
        ...
        Attributes:
            ...
            InlinePolicies:
                "inline_policies" stores all the customer inline policies to be attached to the role.

            ManagedPolicies:
                "managed_policies" stores all the customer managed policies to be attached to the role.
