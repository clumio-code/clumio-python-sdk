...
T = TypeVar('T', bound='ConnectionRegionListLinks')


class ConnectionRegionListLinks:
    """Implementation of the 'ConnectionRegionListLinks' model.
    ...
    def __init__(
        ...
        """Constructor for the ConnectionRegionListLinks class."""
