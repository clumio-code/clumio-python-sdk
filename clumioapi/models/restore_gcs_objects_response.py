...
from clumioapi.models import restore_gcs_objects_links as restore_gcs_objects_links_
import requests

T = TypeVar('T', bound='RestoreGCSObjectsResponse')


@dataclasses.dataclass
class RestoreGCSObjectsResponse:
    """Implementation of the 'RestoreGCSObjectsResponse' model.
    ...
    Links: restore_gcs_objects_links_.RestoreGCSObjectsLinks | None = None
    ...
    def from_dictionary(
        ...
        val_links = restore_gcs_objects_links_.RestoreGCSObjectsLinks.from_dictionary(val)
