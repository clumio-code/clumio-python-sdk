...
class ListDynamoDBTableResponse:
    ...
    def __init__(
        self,
        embedded: dynamo_db_table_list_embedded_.DynamoDBTableListEmbedded,
        links: dynamo_db_table_list_links_.DynamoDBTableListLinks,
        current_count: int,
        limit: int,
        start: str,
        total_count: int,
        ...
        self.embedded: dynamo_db_table_list_embedded_.DynamoDBTableListEmbedded = embedded
        self.links: dynamo_db_table_list_links_.DynamoDBTableListLinks = links
