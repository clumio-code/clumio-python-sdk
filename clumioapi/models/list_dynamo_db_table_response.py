...
class ListDynamoDBTableResponse:
    ...
    def __init__(
        ...
        self.embedded: dynamo_db_table_list_embedded_.DynamoDBTableListEmbedded | None = embedded
        self.links: dynamo_db_table_list_links_.DynamoDBTableListLinks | None = links
