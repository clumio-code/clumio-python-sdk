...
T = TypeVar('T', bound='PreviewGcsProtectionGroupV1Request')


@dataclasses.dataclass
class PreviewGcsProtectionGroupV1Request:
    """Implementation of the 'PreviewGcsProtectionGroupV1Request' model.

    Attributes:
        BackupId:
            The clumio-assigned id of the protection group gcs asset backup to be restored.
            use the
            [get /backups/gcp/protection-groups/assets](#operation/list-backup-gcp-
            protection-group-gcs-assets)
