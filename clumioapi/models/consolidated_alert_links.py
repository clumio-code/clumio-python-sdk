...
class ConsolidatedAlertLinks:
    ...
    def __init__(
        ...
        update_consolidated_alert: hateoas_link_.HateoasLink | None = None,
    ) -> None:
        """Constructor for the ConsolidatedAlertLinks class."""

        # Initialize members of the class
        self.p_self: hateoas_self_link_.HateoasSelfLink | None = p_self
        self.update_consolidated_alert: hateoas_link_.HateoasLink | None = update_consolidated_alert
