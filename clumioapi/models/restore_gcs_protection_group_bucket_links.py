...
T = TypeVar('T', bound='RestoreGCSProtectionGroupBucketLinks')


@dataclasses.dataclass
class RestoreGCSProtectionGroupBucketLinks:
    """Implementation of the 'RestoreGCSProtectionGroupBucketLinks' model.
