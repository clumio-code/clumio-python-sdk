...
T = TypeVar('T', bound='DeletePolicyResponseLinks')


class DeletePolicyResponseLinks:
    """Implementation of the 'DeletePolicyResponseLinks' model.
    ...
    def __init__(
        ...
        """Constructor for the DeletePolicyResponseLinks class."""
