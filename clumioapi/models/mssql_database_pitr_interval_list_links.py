...
T = TypeVar('T', bound='MssqlDatabasePitrIntervalListLinks')


class MssqlDatabasePitrIntervalListLinks:
    """Implementation of the 'MssqlDatabasePitrIntervalListLinks' model.
