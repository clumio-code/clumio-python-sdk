...
from clumioapi.models import \
    preview_gcs_protection_group_async_links as preview_gcs_protection_group_async_links_
import requests

T = TypeVar('T', bound='PreviewGCSProtectionGroupAsyncResponse')


@dataclasses.dataclass
class PreviewGCSProtectionGroupAsyncResponse:
    """Implementation of the 'PreviewGCSProtectionGroupAsyncResponse' model.
    ...
    Links: preview_gcs_protection_group_async_links_.PreviewGCSProtectionGroupAsyncLinks | None = (
        None
    )
    ...
    def from_dictionary(
        ...
        val_links = preview_gcs_protection_group_async_links_.PreviewGCSProtectionGroupAsyncLinks.from_dictionary(
            val
        )
