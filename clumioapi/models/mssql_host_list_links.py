...
T = TypeVar('T', bound='MssqlHostListLinks')


class MssqlHostListLinks:
    """Implementation of the 'MssqlHostListLinks' model.
    ...
    def __init__(
        ...
        """Constructor for the MssqlHostListLinks class."""
