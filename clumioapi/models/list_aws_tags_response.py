...
from clumioapi.models import aws_tag_list_embedded as aws_tag_list_embedded_
from clumioapi.models import aws_tag_list_links as aws_tag_list_links_

T = TypeVar('T', bound='ListAwsTagsResponse')


class ListAwsTagsResponse:
    """Implementation of the 'ListAwsTagsResponse' model.
    ...
    def __init__(
        self,
        embedded: aws_tag_list_embedded_.AwsTagListEmbedded | None = None,
        links: aws_tag_list_links_.AwsTagListLinks | None = None,
        ...
        """Constructor for the ListAwsTagsResponse class."""

        # Initialize members of the class
        self.embedded: aws_tag_list_embedded_.AwsTagListEmbedded | None = embedded
        self.links: aws_tag_list_links_.AwsTagListLinks | None = links
    ...
    def from_dictionary(cls: Type[T], dictionary: Mapping[str, Any]) -> T:
        ...
        val_embedded = aws_tag_list_embedded_.AwsTagListEmbedded.from_dictionary(val)

        val = dictionary.get('_links', None)
        val_links = aws_tag_list_links_.AwsTagListLinks.from_dictionary(val)
