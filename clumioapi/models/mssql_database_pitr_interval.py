...
T = TypeVar('T', bound='MssqlDatabasePitrInterval')


class MssqlDatabasePitrInterval:
    """Implementation of the 'MssqlDatabasePitrInterval' model.
    ...
    def __init__(self, end_timestamp: str = None, start_timestamp: str = None) -> None:
        """Constructor for the MssqlDatabasePitrInterval class."""
