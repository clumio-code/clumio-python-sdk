...
class PolicyListLinks:
    ...
    def __init__(
        ...
        create_policy_definition: hateoas_link_.HateoasLink,
    ) -> None:
        ...
        self.create_policy_definition: hateoas_link_.HateoasLink = create_policy_definition
    ...
    def from_dictionary(cls: Type[T], dictionary: Mapping[str, Any]) -> T:
        ...
        val = dictionary['create-policy-definition']
        ...
        return cls(
            ...
            val_create_policy_definition,  # type: ignore
        )
