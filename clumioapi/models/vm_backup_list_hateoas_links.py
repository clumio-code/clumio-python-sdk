...
T = TypeVar('T', bound='VMBackupListHateoasLinks')


class VMBackupListHateoasLinks:
    """Implementation of the 'VMBackupListHateoasLinks' model.
    ...
    def __init__(
        ...
        """Constructor for the VMBackupListHateoasLinks class."""
