...
from clumioapi.models import mssql_instance_embedded, mssql_instance_links, protection_info

T = TypeVar('T', bound='ReadMssqlInstanceResponse')


class ReadMssqlInstanceResponse:
    """Implementation of the 'ReadMssqlInstanceResponse' model.
