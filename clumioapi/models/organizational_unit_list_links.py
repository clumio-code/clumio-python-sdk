...
T = TypeVar('T', bound='OrganizationalUnitListLinks')


class OrganizationalUnitListLinks:
    """Implementation of the 'OrganizationalUnitListLinks' model.
    ...
    def __init__(
        ...
        """Constructor for the OrganizationalUnitListLinks class."""
