...
T = TypeVar('T', bound='EbsVolumeListLinks')


class EbsVolumeListLinks:
    """Implementation of the 'EbsVolumeListLinks' model.
    ...
    def __init__(
        ...
        """Constructor for the EbsVolumeListLinks class."""
