...
from clumioapi.models import restore_dynamo_db_table_links
...
class RestoreDynamoDBTableResponse:
    ...
    def __init__(
        ...
        links: restore_dynamo_db_table_links.RestoreDynamoDBTableLinks = None,
        task_id: str = None,
    ) -> None:
        ...
        self.links: restore_dynamo_db_table_links.RestoreDynamoDBTableLinks = links
    ...
    def from_dictionary(cls: Type, dictionary: Mapping[str, Any]) -> Optional[T]:
        ...
        key = '_links'
        links = (
            restore_dynamo_db_table_links.RestoreDynamoDBTableLinks.from_dictionary(
                dictionary.get(key)
            )
            if dictionary.get(key)
            else None
