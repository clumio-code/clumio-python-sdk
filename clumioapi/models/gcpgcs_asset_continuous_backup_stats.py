...
T = TypeVar('T', bound='GCPGCSAssetContinuousBackupStats')


@dataclasses.dataclass
class GCPGCSAssetContinuousBackupStats:
    """Implementation of the 'GCPGCSAssetContinuousBackupStats' model.

    GCSAssetContinuousBackupStats is one bin of CDP execution and
    dmover/drainaggregates for a GCS asset. Used for both the window-wide total and
    per-binentries in the continuous-backup-stats response.
