...
T = TypeVar('T', bound='GCSRestorePitrTimestamps')


@dataclasses.dataclass
class GCSRestorePitrTimestamps:
    """Implementation of the 'GCSRestorePitrTimestamps' model.

    Time bounds shared by restore and preview endpoints. Restore endpointsembed this
    with a resource ID; preview endpoints use it as-is (the resourceID lives in the
    URL path).
