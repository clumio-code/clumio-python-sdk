...
T = TypeVar('T', bound='VCenterFolderLinks')


class VCenterFolderLinks:
    """Implementation of the 'VCenterFolderLinks' model.
    ...
    def __init__(
        ...
        """Constructor for the VCenterFolderLinks class."""
