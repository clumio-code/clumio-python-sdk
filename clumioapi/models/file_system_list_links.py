...
T = TypeVar('T', bound='FileSystemListLinks')


class FileSystemListLinks:
    """Implementation of the 'FileSystemListLinks' model.
    ...
    def __init__(
        ...
        """Constructor for the FileSystemListLinks class."""
