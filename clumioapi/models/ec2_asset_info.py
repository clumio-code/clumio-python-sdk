...
T = TypeVar('T', bound='Ec2AssetInfo')


class Ec2AssetInfo:
    """Implementation of the 'Ec2AssetInfo' model.

    Ec2AssetInfoThe installed information for the EC2 feature.
    ...
    def __init__(self, installed_template_version: str | None = None) -> None:
        """Constructor for the Ec2AssetInfo class."""
