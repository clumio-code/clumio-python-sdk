...
class RdsResourceRestoreSource:
    ...
    def __init__(
        self,
        backup: rds_resource_restore_source_air_gap_options_.RdsResourceRestoreSourceAirGapOptions,
        snapshot: rds_resource_restore_source_pitr_options_.RdsResourceRestoreSourcePitrOptions,
    ) -> None:
        ...
        self.snapshot: (
            rds_resource_restore_source_pitr_options_.RdsResourceRestoreSourcePitrOptions
        ) = snapshot
