...
class AwsTagEmbedded:
    ...
    def __init__(self,
        read_aws_environment_tag_ebs_volumes_compliance_stats:  = None,
    ...
    def from_dictionary(
        ...
        read_aws_environment_tag_ebs_volumes_compliance_stats = dictionary.get('read-aws-environment-tag-ebs-volumes-compliance-stats')
