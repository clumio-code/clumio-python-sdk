...
class RestoreRdsRecordV1Request:
    ...
    def __init__(self, source: grr_source_.GrrSource, target: grr_target_.GrrTarget) -> None:
        """Constructor for the RestoreRdsRecordV1Request class."""

        # Initialize members of the class
        self.source: grr_source_.GrrSource = source
        self.target: grr_target_.GrrTarget = target
