...
class ListFileVersionsHateoasLinks:
    ...
    def __init__(
        self, list_file_versions: list_file_versions_hateoas_link_.ListFileVersionsHateoasLink
    ) -> None:
    ...
    def from_dictionary(cls: Type[T], dictionary: Mapping[str, Any]) -> T:
        ...
        val = dictionary['list-file-versions']
        ...
        return cls(
            val_list_file_versions,  # type: ignore
        )
