...
class ListEC2MSSQLFCIsResponse:
    ...
    def __init__(
        self,
        embedded: ec2_mssqlfci_list_embedded_.EC2MSSQLFCIListEmbedded,
        links: ec2_mssqlfci_list_links_.EC2MSSQLFCIListLinks,
        current_count: int,
        filter_applied: str,
        limit: int,
        start: str,
        ...
        self.embedded: ec2_mssqlfci_list_embedded_.EC2MSSQLFCIListEmbedded = embedded
        self.links: ec2_mssqlfci_list_links_.EC2MSSQLFCIListLinks = links
