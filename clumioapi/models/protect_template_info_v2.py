...
from clumioapi.models import ebs_template_info, rds_template_info

T = TypeVar('T', bound='ProtectTemplateInfoV2')


class ProtectTemplateInfoV2:
    """Implementation of the 'ProtectTemplateInfoV2' model.
    ...
    def __init__(
        ...
        """Constructor for the ProtectTemplateInfoV2 class."""
