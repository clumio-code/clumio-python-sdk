...
T = TypeVar('T', bound='RdsResourceListLinks')


class RdsResourceListLinks:
    """Implementation of the 'RdsResourceListLinks' model.
    ...
    def __init__(
        ...
        """Constructor for the RdsResourceListLinks class."""
