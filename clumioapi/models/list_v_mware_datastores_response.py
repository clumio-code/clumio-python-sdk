...
class ListVMwareDatastoresResponse:
    """Implementation of the 'ListVMwareDatastoresResponse' model.
    ...
    def __init__(
        self,
        embedded: v_mware_datastore_list_embedded.VMwareDatastoreListEmbedded = None,
        links: v_mware_datastore_list_links.VMwareDatastoreListLinks = None,
        ...
        """Constructor for the ListVMwareDatastoresResponse class."""

        # Initialize members of the class
        self.embedded: v_mware_datastore_list_embedded.VMwareDatastoreListEmbedded = embedded
        self.links: v_mware_datastore_list_links.VMwareDatastoreListLinks = links
    ...
    def from_dictionary(cls: Type, dictionary: Mapping[str, Any]) -> Optional[T]:
        ...
        key = '_embedded'
        embedded = (
            v_mware_datastore_list_embedded.VMwareDatastoreListEmbedded.from_dictionary(
                dictionary.get(key)
            )
        ...
        key = '_links'
        links = (
            v_mware_datastore_list_links.VMwareDatastoreListLinks.from_dictionary(
                dictionary.get(key)
            )
            if dictionary.get(key)
            else None
