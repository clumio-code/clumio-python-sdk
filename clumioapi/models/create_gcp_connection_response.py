...
T = TypeVar('T', bound='CreateGCPConnectionResponse')


@dataclasses.dataclass
class CreateGCPConnectionResponse:
    """Implementation of the 'CreateGCPConnectionResponse' model.

    Attributes:
        Links:
            Urls to pages related to the resource.

        ClumioServiceAccount:
    ...
    def from_dictionary(
        ...
        val = dictionary.get('clumio_service_account', None)
        val_clumio_service_account = val
        ...
        val = dictionary.get('control_plane_id', None)
        val_control_plane_id = val

        val = dictionary.get('control_plane_role', None)
        val_control_plane_role = val
        ...
        return cls(
            val_links,
            val_clumio_service_account,
            val_configuration,
            val_connection_status,
            val_connection_type,
            val_control_plane_id,
            val_control_plane_role,
