...
class ListEC2MSSQLDatabasesResponse:
    ...
    def __init__(
        self,
        embedded: ec2_mssql_database_list_embedded_.EC2MSSQLDatabaseListEmbedded | None = None,
        links: ec2_mssql_database_list_links_.EC2MSSQLDatabaseListLinks | None = None,
        ...
        self.embedded: ec2_mssql_database_list_embedded_.EC2MSSQLDatabaseListEmbedded | None = (
            embedded
        )
        self.links: ec2_mssql_database_list_links_.EC2MSSQLDatabaseListLinks | None = links
