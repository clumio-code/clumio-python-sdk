...
T = TypeVar('T', bound='TimeUnitParamPolicyMinRetentionDuration')


@dataclasses.dataclass
class TimeUnitParamPolicyMinRetentionDuration:
    """Implementation of the 'TimeUnitParamPolicyMinRetentionDuration' model.
