...
from clumioapi.models import \
    gcs_protection_group_backup_list_embedded as gcs_protection_group_backup_list_embedded_
from clumioapi.models import \
    gcs_protection_group_backup_list_links as gcs_protection_group_backup_list_links_
import requests

T = TypeVar('T', bound='ListGCSProtectionGroupBackupsResponse')


@dataclasses.dataclass
class ListGCSProtectionGroupBackupsResponse:
    """Implementation of the 'ListGCSProtectionGroupBackupsResponse' model.
    ...
    Embedded: (
        gcs_protection_group_backup_list_embedded_.GCSProtectionGroupBackupListEmbedded | None
    ) = None
    Links: gcs_protection_group_backup_list_links_.GCSProtectionGroupBackupListLinks | None = None
    ...
    def from_dictionary(
        ...
        val_embedded = gcs_protection_group_backup_list_embedded_.GCSProtectionGroupBackupListEmbedded.from_dictionary(
            val
        )

        val = dictionary.get('_links', None)
        val_links = gcs_protection_group_backup_list_links_.GCSProtectionGroupBackupListLinks.from_dictionary(
            val
        )
