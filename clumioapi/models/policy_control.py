...
class PolicyControl:
    ...
    def __init__(
        ...
        minimum_rpo_frequency: time_unit_param_.TimeUnitParam,
    ) -> None:
        ...
        self.minimum_rpo_frequency: time_unit_param_.TimeUnitParam = minimum_rpo_frequency
    ...
    def from_dictionary(cls: Type[T], dictionary: Mapping[str, Any]) -> T:
        ...
        val = dictionary['minimum_rpo_frequency']
        ...
        return cls(
            ...
            val_minimum_rpo_frequency,  # type: ignore
        )
