...
class DynamoDBTableBackupLinks:
    ...
    def __init__(
        ...
        restore_aws_dynamodb_records: hateoas_link_.HateoasLink,
        ...
        self.restore_aws_dynamodb_records: hateoas_link_.HateoasLink = restore_aws_dynamodb_records
    ...
    def from_dictionary(cls: Type[T], dictionary: Mapping[str, Any]) -> T:
        ...
        val = dictionary['restore-aws-dynamodb-records']
        ...
        return cls(
            ...
            val_restore_aws_dynamodb_records,  # type: ignore
