...
T = TypeVar('T', bound='IcebergTemplateInfo')


class IcebergTemplateInfo:
    """Implementation of the 'IcebergTemplateInfo' model.
    ...
    def __init__(self, available_template_version: str | None = None) -> None:
        """Constructor for the IcebergTemplateInfo class."""
