...
T = TypeVar('T', bound='DatacenterLinks')


class DatacenterLinks:
    """Implementation of the 'DatacenterLinks' model.
    ...
    Attributes:
        ...
        read_vmware_vcenter_datacenter_compliance_stats:
    ...
    _names = {
        ...
        'read_vmware_vcenter_datacenter_compliance_stats': 'read-vmware-vcenter-datacenter-compliance-stats',
    ...
    def __init__(
        ...
        read_vmware_vcenter_datacenter_compliance_stats: read_v_center_object_protection_stats_hateoas_link.ReadVCenterObjectProtectionStatsHateoasLink = None,
        unprotect_entities: unprotect_entities_hateoas_link.UnprotectEntitiesHateoasLink = None,
    ) -> None:
        """Constructor for the DatacenterLinks class."""
        ...
        self.read_vmware_vcenter_datacenter_compliance_stats: read_v_center_object_protection_stats_hateoas_link.ReadVCenterObjectProtectionStatsHateoasLink = (
            read_vmware_vcenter_datacenter_compliance_stats
        )
    ...
    def from_dictionary(cls: Type, dictionary: Mapping[str, Any]) -> Optional[T]:
        ...
        key = 'read-vmware-vcenter-datacenter-compliance-stats'
        read_vmware_vcenter_datacenter_compliance_stats = (
