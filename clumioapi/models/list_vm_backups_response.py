...
class ListVMBackupsResponse:
    """Implementation of the 'ListVMBackupsResponse' model.
    ...
    def __init__(
        self,
        embedded: vm_backup_list_embedded.VMBackupListEmbedded = None,
        links: vm_backup_list_hateoas_links.VMBackupListHateoasLinks = None,
        ...
        """Constructor for the ListVMBackupsResponse class."""

        # Initialize members of the class
        self.embedded: vm_backup_list_embedded.VMBackupListEmbedded = embedded
        self.links: vm_backup_list_hateoas_links.VMBackupListHateoasLinks = links
    ...
    def from_dictionary(cls: Type, dictionary: Mapping[str, Any]) -> Optional[T]:
        ...
        key = '_embedded'
        embedded = (
            vm_backup_list_embedded.VMBackupListEmbedded.from_dictionary(dictionary.get(key))
        ...
        key = '_links'
        links = (
            vm_backup_list_hateoas_links.VMBackupListHateoasLinks.from_dictionary(
                dictionary.get(key)
            )
            if dictionary.get(key)
            else None
