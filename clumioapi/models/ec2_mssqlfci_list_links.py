...
T = TypeVar('T', bound='EC2MSSQLFCIListLinks')


class EC2MSSQLFCIListLinks:
    """Implementation of the 'EC2MSSQLFCIListLinks' model.
    ...
    def __init__(
        ...
        """Constructor for the EC2MSSQLFCIListLinks class."""
