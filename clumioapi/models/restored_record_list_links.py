...
T = TypeVar('T', bound='RestoredRecordListLinks')


class RestoredRecordListLinks:
    """Implementation of the 'RestoredRecordListLinks' model.
    ...
    def __init__(
        ...
        """Constructor for the RestoredRecordListLinks class."""
