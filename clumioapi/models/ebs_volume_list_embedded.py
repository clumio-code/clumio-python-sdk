...
from clumioapi.models import ebs as ebs_
...
class EbsVolumeListEmbedded:
    ...
    def __init__(self, items: Sequence[ebs_.EBS] | None = None) -> None:
        """Constructor for the EbsVolumeListEmbedded class."""

        # Initialize members of the class
        self.items: Sequence[ebs_.EBS] | None = items
    ...
    def from_dictionary(cls: Type[T], dictionary: Mapping[str, Any]) -> T:
        ...
        if val:
            val_items = list()
            for value in val:
                val_items.append(ebs_.EBS.from_dictionary(value))
