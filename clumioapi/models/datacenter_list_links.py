...
T = TypeVar('T', bound='DatacenterListLinks')


class DatacenterListLinks:
    """Implementation of the 'DatacenterListLinks' model.
    ...
    def __init__(
        ...
        """Constructor for the DatacenterListLinks class."""
