...
T = TypeVar('T', bound='VMComputeResourceFolderModel')


class VMComputeResourceFolderModel:
    """Implementation of the 'VMComputeResourceFolderModel' model.
    ...
    def __init__(self, p_id: str = None) -> None:
        """Constructor for the VMComputeResourceFolderModel class."""
