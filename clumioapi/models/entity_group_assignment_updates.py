...
class EntityGroupAssignmentUpdates:
    ...
    def __init__(
        self,
        add: Sequence[role_for_organizational_units_.RoleForOrganizationalUnits],
        remove: Sequence[role_for_organizational_units_.RoleForOrganizationalUnits],
    ) -> None:
        """Constructor for the EntityGroupAssignmentUpdates class."""

        # Initialize members of the class
        self.add: Sequence[role_for_organizational_units_.RoleForOrganizationalUnits] = add
        self.remove: Sequence[role_for_organizational_units_.RoleForOrganizationalUnits] = remove
