...
T = TypeVar('T', bound='EC2InstanceListLinks')


class EC2InstanceListLinks:
    """Implementation of the 'EC2InstanceListLinks' model.
    ...
    def __init__(
        ...
        """Constructor for the EC2InstanceListLinks class."""
