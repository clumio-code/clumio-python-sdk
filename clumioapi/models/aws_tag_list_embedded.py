...
class AwsTagListEmbedded:
    """Implementation of the 'AwsTagListEmbedded' model.
    ...
    def __init__(self, items: Sequence[aws_tag_.AwsTag]) -> None:
        """Constructor for the AwsTagListEmbedded class."""

        # Initialize members of the class
        self.items: Sequence[aws_tag_.AwsTag] = items
