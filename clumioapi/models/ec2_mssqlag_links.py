...
class EC2MSSQLAGLinks:
    ...
    def __init__(
        ...
        get_mssql_ec2_availability_group_stats: hateoas_link_.HateoasLink | None = None,
        read_policy_definition: (
        ...
        self.get_mssql_ec2_availability_group_backup_status_stats: (
            hateoas_link_.HateoasLink | None
        ) = get_mssql_ec2_availability_group_backup_status_stats
        self.get_mssql_ec2_availability_group_stats: hateoas_link_.HateoasLink | None = (
            get_mssql_ec2_availability_group_stats
        )
