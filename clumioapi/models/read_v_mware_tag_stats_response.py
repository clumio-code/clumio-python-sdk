...
from clumioapi.models import v_mware_tag_stats_links

T = TypeVar('T', bound='ReadVMwareTagStatsResponse')


class ReadVMwareTagStatsResponse:
    """Implementation of the 'ReadVMwareTagStatsResponse' model.
    ...
    def __init__(
        self,
        etag: str = None,
        links: v_mware_tag_stats_links.VMwareTagStatsLinks = None,
        ...
        """Constructor for the ReadVMwareTagStatsResponse class."""

        # Initialize members of the class
        self.etag: str = etag
        self.links: v_mware_tag_stats_links.VMwareTagStatsLinks = links
    ...
    def from_dictionary(cls: Type, dictionary: Mapping[str, Any]) -> Optional[T]:
        ...
        key = '_links'
        links = (
            v_mware_tag_stats_links.VMwareTagStatsLinks.from_dictionary(dictionary.get(key))
