...
class UserListHateoasLinks:
    """Implementation of the 'UserListHateoasLinks' model.
    ...
    def __init__(
        ...
        create_user: hateoas_link_.HateoasLink | None = None,
    ) -> None:
        ...
        self.create_user: hateoas_link_.HateoasLink | None = create_user
    ...
    def from_dictionary(cls: Type[T], dictionary: Mapping[str, Any]) -> T:
        ...
        val = dictionary.get('create-user', None)
