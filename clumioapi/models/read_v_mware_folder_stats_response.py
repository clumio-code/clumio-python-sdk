...
from clumioapi.models import v_mware_folder_stats_links

T = TypeVar('T', bound='ReadVMwareFolderStatsResponse')


class ReadVMwareFolderStatsResponse:
    """Implementation of the 'ReadVMwareFolderStatsResponse' model.
    ...
    def __init__(
        self,
        etag: str = None,
        links: v_mware_folder_stats_links.VMwareFolderStatsLinks = None,
        ...
        """Constructor for the ReadVMwareFolderStatsResponse class."""

        # Initialize members of the class
        self.etag: str = etag
        self.links: v_mware_folder_stats_links.VMwareFolderStatsLinks = links
    ...
    def from_dictionary(cls: Type, dictionary: Mapping[str, Any]) -> Optional[T]:
        ...
        key = '_links'
        links = (
            v_mware_folder_stats_links.VMwareFolderStatsLinks.from_dictionary(dictionary.get(key))
