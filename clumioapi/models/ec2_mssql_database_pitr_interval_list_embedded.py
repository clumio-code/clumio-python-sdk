...
class EC2MssqlDatabasePitrIntervalListEmbedded:
    ...
    def __init__(
        self, items: Sequence[ec2_mssql_database_pitr_interval_.EC2MssqlDatabasePitrInterval]
    ) -> None:
        """Constructor for the EC2MssqlDatabasePitrIntervalListEmbedded class."""

        # Initialize members of the class
        self.items: Sequence[ec2_mssql_database_pitr_interval_.EC2MssqlDatabasePitrInterval] = items
