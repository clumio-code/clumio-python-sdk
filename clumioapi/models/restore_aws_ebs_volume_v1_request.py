...
class RestoreAwsEbsVolumeV1Request:
    ...
    def __init__(
        self,
        source: ebs_restore_source_v1_.EBSRestoreSourceV1,
        target: ebs_restore_target_v1_.EBSRestoreTargetV1,
    ) -> None:
        """Constructor for the RestoreAwsEbsVolumeV1Request class."""

        # Initialize members of the class
        self.source: ebs_restore_source_v1_.EBSRestoreSourceV1 = source
        self.target: ebs_restore_target_v1_.EBSRestoreTargetV1 = target
