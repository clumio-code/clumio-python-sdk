...
from clumioapi.models import export_threat_report_links as export_threat_report_links_
from clumioapi.models import read_task_hateoas_outer_embedded as read_task_hateoas_outer_embedded_
import requests

T = TypeVar('T', bound='ExportThreatReportResponse')


@dataclasses.dataclass
class ExportThreatReportResponse:
    """Implementation of the 'ExportThreatReportResponse' model.
    ...
    Links: export_threat_report_links_.ExportThreatReportLinks | None = None
    ...
    def from_dictionary(
        ...
        val_links = export_threat_report_links_.ExportThreatReportLinks.from_dictionary(val)
