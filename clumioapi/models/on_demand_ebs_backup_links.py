...
T = TypeVar('T', bound='OnDemandEBSBackupLinks')


class OnDemandEBSBackupLinks:
    """Implementation of the 'OnDemandEBSBackupLinks' model.
    ...
    def __init__(
        ...
        """Constructor for the OnDemandEBSBackupLinks class."""
