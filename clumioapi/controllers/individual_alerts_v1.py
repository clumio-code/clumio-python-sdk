...
class IndividualAlertsV1Controller(base_controller.BaseController):
    ...
    def list_individual_alerts(
        ...
        start: str | None = None,
        sort: str | None = None,
        filter: individual_alerts_types.ListIndividualAlertsV1FilterT | None = None,
        embed: str | None = None,
        **kwargs,
        ...
        def get_instance_from_response(response: requests.Response) -> Any:
            return list_alerts_response.ListAlertsResponse.from_response(response)
    ...
    def read_individual_alert(
        ...
        def get_instance_from_response(response: requests.Response) -> Any:
            return read_alert_response.ReadAlertResponse.from_response(response)
    ...
    def update_individual_alert(
        ...
        **kwargs,
        ...
        def get_instance_from_response(response: requests.Response) -> Any:
            return update_alert_response.UpdateAlertResponse.from_response(response)
...
class IndividualAlertsV1ControllerPaginator(base_controller.BaseController):
    """A Controller to access Endpoints for individual-alerts resource with pagination."""

    def __init__(self, config: configuration.Configuration) -> None:
        super().__init__(config)
        self.controller = IndividualAlertsV1Controller(config)
    ...
    def list_individual_alerts(
        ...
        **kwargs,
        ...
        start = start or '1'
        while True:
            response = self.controller.list_individual_alerts(
