...
from clumioapi.controllers.types import individual_alerts_types
...
class IndividualAlertsV1Controller:
    ...
    def list_individual_alerts(
        ...
        sort: str | None = None,
        filter: (
            individual_alerts_types.ListIndividualAlertsV1FilterT
            | individual_alerts_types.ListIndividualAlertsV1FilterTypeDef
            | None
        ) = None,
        embed: str | None = None,
        **kwargs,
        ...
        def get_instance_from_response(resp: requests.Response) -> Any:
            return list_alerts_response.ListAlertsResponse.from_response(resp)
        ...
        _query_parameters = {
            ...
            'filter': api_helper.to_filter_query_str(
                filter, individual_alerts_types.ListIndividualAlertsV1FilterT
            ),
            'embed': embed,
        }

        resp_instance: list_alerts_response.ListAlertsResponse
        # Execute request
        ...
        if not resp.ok:
            error_str = f'list_individual_alerts for url {urllib.parse.unquote(resp.url)} failed.'
    ...
    def read_individual_alert(
        ...
        def get_instance_from_response(resp: requests.Response) -> Any:
            return read_alert_response.ReadAlertResponse.from_response(resp)
        ...
        resp_instance: read_alert_response.ReadAlertResponse
        # Execute request
        resp: requests.Response
        try:
            resp = self.client.get(
        ...
        if not resp.ok:
            error_str = f'read_individual_alert for url {urllib.parse.unquote(resp.url)} failed.'
            raise clumio_exception.ClumioException(error_str, resp=resp)
    ...
    def update_individual_alert(
        ...
        **kwargs,
        ...
        def get_instance_from_response(resp: requests.Response) -> Any:
            return update_alert_response.UpdateAlertResponse.from_response(resp)
        ...
        resp_instance: update_alert_response.UpdateAlertResponse
        # Execute request
        resp: requests.Response
        try:
        ...
        if not resp.ok:
            error_str = f'update_individual_alert for url {urllib.parse.unquote(resp.url)} failed.'
            raise clumio_exception.ClumioException(error_str, resp=resp)
...
class IndividualAlertsV1ControllerPaginator:
    """A Controller to access Endpoints for individual-alerts resource with pagination."""
    ...
    def list_individual_alerts(
        ...
        embed: str | None = None,
        **kwargs,
    ) -> Iterator[list_alerts_response.ListAlertsResponse]:
        """Returns a list of individual alerts.
        ...
        """
        controller = IndividualAlertsV1Controller(self.controller)
        while True:
            response = controller.list_individual_alerts(
