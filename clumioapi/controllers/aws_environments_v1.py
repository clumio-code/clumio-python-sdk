...
class AwsEnvironmentsV1Controller:
    ...
    def list_aws_environments(
        ...
        start: str | None = None,
        filter: (
            aws_environments_types.ListAwsEnvironmentsV1FilterT
            | aws_environments_types.ListAwsEnvironmentsV1FilterTypeDef
            | None
        ) = None,
        embed: str | None = None,
        ...
        **kwargs,
        ...
        _query_parameters = {
            ...
            'filter': api_helper.to_filter_query_str(
                filter, aws_environments_types.ListAwsEnvironmentsV1FilterT
            ),
            'embed': embed,
