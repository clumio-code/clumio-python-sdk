...
class AwsEnvironmentsV1Controller(base_controller.BaseController):
    ...
    def list_aws_environments(
        ...
        **kwargs,
        ...
        def get_instance_from_response(response: requests.Response) -> Any:
            return list_aws_environments_response.ListAWSEnvironmentsResponse.from_response(
                response
            )
    ...
    def read_aws_environment(
        ...
        **kwargs,
        ...
        def get_instance_from_response(response: requests.Response) -> Any:
            return read_aws_environment_response.ReadAWSEnvironmentResponse.from_response(response)
...
class AwsEnvironmentsV1ControllerPaginator(base_controller.BaseController):
    """A Controller to access Endpoints for aws-environments resource with pagination."""

    def __init__(self, config: configuration.Configuration) -> None:
        super().__init__(config)
        self.controller = AwsEnvironmentsV1Controller(config)
    ...
    def list_aws_environments(
        ...
        **kwargs,
        ...
        start = start or '1'
        while True:
            response = self.controller.list_aws_environments(
                limit=limit,
                start=start,
                filter=filter,
                embed=embed,
