...
class AutoUserProvisioningRulesV1Controller:
    ...
    def list_auto_user_provisioning_rules(
        ...
        start: str | None = None,
        filter: (
            auto_user_provisioning_rules_types.ListAutoUserProvisioningRulesV1FilterT
            | auto_user_provisioning_rules_types.ListAutoUserProvisioningRulesV1FilterTypeDef
            | None
        ) = None,
        **kwargs,
        ...
        _query_parameters = {
            ...
            'filter': api_helper.to_filter_query_str(
                filter, auto_user_provisioning_rules_types.ListAutoUserProvisioningRulesV1FilterT
            ),
        }
