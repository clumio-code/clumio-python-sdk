...
class AutoUserProvisioningRulesV1Controller(base_controller.BaseController):
    ...
    def create_auto_user_provisioning_rule(
        self,
        body: create_auto_user_provisioning_rule_v1_request.CreateAutoUserProvisioningRuleV1Request,
        **kwargs,
    ) -> Union[
    ...
    def update_auto_user_provisioning_rule(
        self,
        rule_id: str,
        body: update_auto_user_provisioning_rule_v1_request.UpdateAutoUserProvisioningRuleV1Request,
        **kwargs,
    ) -> Union[
