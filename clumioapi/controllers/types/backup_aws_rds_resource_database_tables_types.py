...
@deprecated(
    'Use the ListBackupAwsRdsResourceDatabaseTablesV1FilterTypeDef dict instead. Retained for '
...
class ListBackupAwsRdsResourceDatabaseTablesV1FilterT(
    ...
    """Deprecated: pass a dict typed as ``ListBackupAwsRdsResourceDatabaseTablesV1FilterTypeDef`` instead.
...
class ListBackupAwsRdsResourceDatabaseTablesV1FilterTypeDef(TypedDict, total=False):
