...
@deprecated(
    'Use the ListRdsRestoredRecordsV1FilterTypeDef dict instead. Retained for '
...
class ListRdsRestoredRecordsV1FilterT(base_controller_filter_types.BaseControllerFilterTypes):
    """Deprecated: pass a dict typed as ``ListRdsRestoredRecordsV1FilterTypeDef`` instead.
...
class ListRdsRestoredRecordsV1FilterTypeDef(TypedDict, total=False):
    asset_id: Mapping[Literal['$eq'], str]
    task_id: Mapping[Literal['$in'], list]
