...
@deprecated(
    'Use the ListAutoUserProvisioningRulesV1FilterTypeDef dict instead. Retained for '
...
class ListAutoUserProvisioningRulesV1FilterT(
    ...
    """Deprecated: pass a dict typed as ``ListAutoUserProvisioningRulesV1FilterTypeDef`` instead.
...
class ListAutoUserProvisioningRulesV1FilterTypeDef(TypedDict, total=False):
