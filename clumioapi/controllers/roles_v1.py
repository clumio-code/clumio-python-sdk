...
class RolesV1Controller:
    ...
    def list_roles(self, **kwargs):
        ...
        def get_instance_from_response(resp: requests.Response) -> Any:
            return list_roles_response.ListRolesResponse.from_response(resp)
    ...
    def list_permissions(self, **kwargs):
        ...
        def get_instance_from_response(resp: requests.Response) -> Any:
            return list_permissions_response.ListPermissionsResponse.from_response(resp)
    ...
    def read_role(
        ...
        def get_instance_from_response(resp: requests.Response) -> Any:
            return read_role_response.ReadRoleResponse.from_response(resp)
...
class RolesV1ControllerPaginator:
