...
class UsersV1Controller:
    ...
    def list_users(
        ...
        limit: int | None = None,
        start: str | None = None,
        filter: users_types.ListUsersV1FilterT | users_types.ListUsersV1FilterTypeDef | None = None,
        **kwargs,
        ...
        _query_parameters = {
            'limit': limit,
            'start': start,
            'filter': api_helper.to_filter_query_str(filter, users_types.ListUsersV1FilterT),
        }
