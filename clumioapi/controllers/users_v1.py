...
class UsersV1Controller(base_controller.BaseController):
    ...
    def list_users(
        ...
        **kwargs,
        ...
        def get_instance_from_response(response: requests.Response) -> Any:
            return list_users_response_v1.ListUsersResponseV1.from_response(response)
    ...
    def create_user(
        ...
        def get_instance_from_response(response: requests.Response) -> Any:
            return create_user_response_v1.CreateUserResponseV1.from_response(response)
    ...
    def update_user_profile(
        ...
        **kwargs,
        ...
        def get_instance_from_response(response: requests.Response) -> Any:
            return edit_profile_response_v1.EditProfileResponseV1.from_response(response)
    ...
    def read_user(
        ...
        def get_instance_from_response(response: requests.Response) -> Any:
            return read_user_response_v1.ReadUserResponseV1.from_response(response)
    ...
    def delete_user(
        ...
        def get_instance_from_response(response: requests.Response) -> Any:
            return delete_user_response_v1.DeleteUserResponseV1.from_response(response)
    ...
    def update_user(
        ...
        **kwargs,
        ...
        def get_instance_from_response(response: requests.Response) -> Any:
            return update_user_response_v1.UpdateUserResponseV1.from_response(response)
    ...
    def change_password(
        ...
        **kwargs,
        ...
        def get_instance_from_response(response: requests.Response) -> Any:
            return change_password_response.ChangePasswordResponse.from_response(response)
...
class UsersV1ControllerPaginator(base_controller.BaseController):
    """A Controller to access Endpoints for users resource with pagination."""

    def __init__(self, config: configuration.Configuration) -> None:
        super().__init__(config)
        self.controller = UsersV1Controller(config)
    ...
    def list_users(
        ...
        **kwargs,
        ...
        start = start or '1'
        while True:
            response = self.controller.list_users(limit=limit, start=start, filter=filter, **kwargs)
            yield response
