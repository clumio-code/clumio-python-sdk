...
class BackupAwsEbsVolumesV2Controller(base_controller.BaseController):
    ...
    def list_backup_aws_ebs_volumes(
        ...
        **kwargs,
        ...
        def get_instance_from_response(response: requests.Response) -> Any:
            return list_ebs_backups_response.ListEBSBackupsResponse.from_response(response)
    ...
    def create_backup_aws_ebs_volume(
        ...
        **kwargs,
        ...
        def get_instance_from_response(response: requests.Response) -> Any:
            return on_demand_ebs_backup_response.OnDemandEBSBackupResponse.from_response(response)
    ...
    def read_backup_aws_ebs_volume(
        ...
        def get_instance_from_response(response: requests.Response) -> Any:
            return read_ebs_backup_response.ReadEBSBackupResponse.from_response(response)
...
class BackupAwsEbsVolumesV2ControllerPaginator(base_controller.BaseController):
    """A Controller to access Endpoints for backup-aws-ebs-volumes resource with pagination."""

    def __init__(self, config: configuration.Configuration) -> None:
        super().__init__(config)
        self.controller = BackupAwsEbsVolumesV2Controller(config)
