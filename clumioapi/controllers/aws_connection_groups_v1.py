...
class AwsConnectionGroupsV1Controller(base_controller.BaseController):
    ...
    def list_aws_connection_groups(
        ...
        return list_connection_groups_response.ListConnectionGroupsResponse.from_dictionary(resp)

    def create_aws_connection_group(
        self,
        body: create_aws_connection_group_v1_request.CreateAwsConnectionGroupV1Request = None,
        **kwargs,
    ) -> Union[
        ...
        return create_connection_group_response.CreateConnectionGroupResponse.from_dictionary(resp)

    def read_aws_connection_group(
        self, connection_group_id: str, embed: str = None, return_external_id: bool = None, **kwargs
    ) -> Union[
        ...
        return read_connection_group_response.ReadConnectionGroupResponse.from_dictionary(resp)

    def update_aws_connection_group(
        self,
        connection_group_id: str,
        body: update_aws_connection_group_v1_request.UpdateAwsConnectionGroupV1Request = None,
        **kwargs,
    ) -> Union[
        ...
        return update_connection_group_response.UpdateConnectionGroupResponse.from_dictionary(resp)
