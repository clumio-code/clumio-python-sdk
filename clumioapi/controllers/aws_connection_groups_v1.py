...
class AwsConnectionGroupsV1Controller(base_controller.BaseController):
    ...
    def list_aws_connection_groups(self, limit: int, start: str, filter: str, **kwargs) -> Union[
    ...
    def create_aws_connection_group(
        self,
        body: create_aws_connection_group_v1_request.CreateAwsConnectionGroupV1Request,
        **kwargs,
    ) -> Union[
    ...
    def read_aws_connection_group(
        self, connection_group_id: str, embed: str, return_external_id: bool, **kwargs
    ) -> Union[
    ...
    def update_aws_connection_group(
        ...
        body: update_aws_connection_group_v1_request.UpdateAwsConnectionGroupV1Request,
        **kwargs,
    ) -> Union[
