        ...
        **kwargs,
        ...
        try:
            ...
            raise clumio_exception.ClumioException(
                'Error occurred while executing list_aws_connection_groups', error=http_error
            )

        obj = list_connection_groups_response.ListConnectionGroupsResponse.from_dictionary(
            resp.json()
        )
        if raw_response:
            return resp, obj
        ...
        **kwargs,
        ...
        try:
            ...
            if raw_response:
                return http_error.response, None
            raise clumio_exception.ClumioException(
                'Error occurred while executing create_aws_connection_group', error=http_error
            )

        obj = create_connection_group_response.CreateConnectionGroupResponse.from_dictionary(
            resp.json()
        )
        if raw_response:
            return resp, obj
        ...
        **kwargs,
        ...
        try:
            ...
            if raw_response:
                return http_error.response, None
            raise clumio_exception.ClumioException(
                'Error occurred while executing read_aws_connection_group', error=http_error
            )

        obj = read_connection_group_response.ReadConnectionGroupResponse.from_dictionary(
            resp.json()
        )
        if raw_response:
            return resp, obj
        ...
        **kwargs,
        ...
        try:
            ...
            if raw_response:
                return http_error.response, None
            raise clumio_exception.ClumioException(
                'Error occurred while executing update_aws_connection_group', error=http_error
            )

        obj = update_connection_group_response.UpdateConnectionGroupResponse.from_dictionary(
            resp.json()
        )
        if raw_response:
            return resp, obj
