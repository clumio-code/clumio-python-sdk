...
class PolicyRulesV1Controller(base_controller.BaseController):
    ...
    def list_policy_rules(
        ...
        **kwargs,
        ...
        def get_instance_from_response(response: requests.Response) -> Any:
            return list_rules_response.ListRulesResponse.from_response(response)
    ...
    def create_policy_rule(
        ...
        def get_instance_from_response(response: requests.Response) -> Any:
            return create_rule_response.CreateRuleResponse.from_response(response)
    ...
    def read_policy_rule(
        ...
        def get_instance_from_response(response: requests.Response) -> Any:
            return read_rule_response.ReadRuleResponse.from_response(response)
    ...
    def update_policy_rule(
        ...
        **kwargs,
        ...
        def get_instance_from_response(response: requests.Response) -> Any:
            return update_rule_response.UpdateRuleResponse.from_response(response)
    ...
    def delete_policy_rule(
        ...
        def get_instance_from_response(response: requests.Response) -> Any:
            return delete_rule_response.DeleteRuleResponse.from_response(response)
...
class PolicyRulesV1ControllerPaginator(base_controller.BaseController):
    """A Controller to access Endpoints for policy-rules resource with pagination."""

    def __init__(self, config: configuration.Configuration) -> None:
        super().__init__(config)
        self.controller = PolicyRulesV1Controller(config)
    ...
    def list_policy_rules(
        ...
        **kwargs,
        ...
        start = start or '1'
        while True:
            response = self.controller.list_policy_rules(
                limit=limit,
                start=start,
                organizational_unit_id=organizational_unit_id,
                sort=sort,
