...
class RestoredProtectionGroupS3AssetsV1Controller(base_controller.BaseController):
    ...
    def restore_protection_group_s3_asset(
        ...
        Returns:
            RestoreProtectionGroupS3AssetResponse: Response from the API.
        Raises:
    ...
    def preview_protection_group_s3_asset(
        ...
        Returns:
            PreviewProtectionGroupS3AssetSyncResponse: Response from the API.
        Raises:
            ClumioException: An error occured while executing the API.
                This exception includes the HTTP response code, an error
                message, and the HTTP body that was received in the request.
    ...
    def preview_details_protection_group_s3_asset(
        ...
        Returns:
            PreviewProtectionGroupS3AssetDetailsResponse: Response from the API.
        Raises:
            ClumioException: An error occured while executing the API.
                This exception includes the HTTP response code, an error
                message, and the HTTP body that was received in the request.
