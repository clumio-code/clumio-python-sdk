...
class TasksV1Controller(base_controller.BaseController):
    ...
    def list_tasks(
        ...
        **kwargs,
        ...
        def get_instance_from_response(response: requests.Response) -> Any:
            return list_tasks_response.ListTasksResponse.from_response(response)
    ...
    def read_task(
        ...
        def get_instance_from_response(response: requests.Response) -> Any:
            return read_task_response.ReadTaskResponse.from_response(response)
    ...
    def update_task(
        ...
        **kwargs,
        ...
        def get_instance_from_response(response: requests.Response) -> Any:
            return update_task_response.UpdateTaskResponse.from_response(response)
...
class TasksV1ControllerPaginator(base_controller.BaseController):
    """A Controller to access Endpoints for tasks resource with pagination."""

    def __init__(self, config: configuration.Configuration) -> None:
        super().__init__(config)
        self.controller = TasksV1Controller(config)
    ...
    def list_tasks(
        ...
        **kwargs,
        ...
        start = start or '1'
        while True:
            response = self.controller.list_tasks(limit=limit, start=start, filter=filter, **kwargs)
            yield response
