...
class RestoredAwsEbsVolumesV1Controller(base_controller.BaseController):
    ...
    def restore_aws_ebs_volume(
        self, body: restore_aws_ebs_volume_v1_request.RestoreAwsEbsVolumeV1Request, **kwargs
    ) -> Union[
        ...
        return restore_ebs_response_v1.RestoreEBSResponseV1.from_dictionary(resp.json())
