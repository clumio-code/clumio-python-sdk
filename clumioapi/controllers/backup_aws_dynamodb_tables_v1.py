...
class BackupAwsDynamodbTablesV1Controller(base_controller.BaseController):
        ...
        **kwargs,
        ...
        try:
            ...
            raise clumio_exception.ClumioException(
                'Error occurred while executing list_backup_aws_dynamodb_tables', error=http_error
            )
        ...
        **kwargs,
        ...
        try:
            ...
            if raw_response:
                return http_error.response, None
            raise clumio_exception.ClumioException(
                'Error occurred while executing create_backup_aws_dynamodb_table', error=http_error
            )

        obj = on_demand_dynamo_db_backup_response.OnDemandDynamoDBBackupResponse.from_dictionary(
            resp.json()
        )
        if raw_response:
            return resp, obj
    ...
    def read_backup_aws_dynamodb_table(self, backup_id: str | None = None, **kwargs) -> Union[
        ...
        try:
            ...
            if raw_response:
                return http_error.response, None
            raise clumio_exception.ClumioException(
                'Error occurred while executing read_backup_aws_dynamodb_table', error=http_error
            )

        obj = read_dynamo_db_table_backup_response.ReadDynamoDBTableBackupResponse.from_dictionary(
            resp.json()
        )
        if raw_response:
            return resp, obj
