...
class AwsEc2InstancesV1Controller(base_controller.BaseController):
    ...
    def list_aws_ec2_instances(
        ...
        **kwargs,
        ...
        def get_instance_from_response(response: requests.Response) -> Any:
            return list_ec2_instances_response.ListEc2InstancesResponse.from_response(response)
    ...
    def read_aws_ec2_instance(
        ...
        **kwargs,
        ...
        def get_instance_from_response(response: requests.Response) -> Any:
            return read_ec2_instance_response.ReadEc2InstanceResponse.from_response(response)
...
class AwsEc2InstancesV1ControllerPaginator(base_controller.BaseController):
    """A Controller to access Endpoints for aws-ec2-instances resource with pagination."""

    def __init__(self, config: configuration.Configuration) -> None:
        super().__init__(config)
        self.controller = AwsEc2InstancesV1Controller(config)
    ...
    def list_aws_ec2_instances(
        ...
        **kwargs,
        ...
        start = start or '1'
        while True:
            response = self.controller.list_aws_ec2_instances(
                limit=limit,
                start=start,
                filter=filter,
                embed=embed,
