...
class UsersV2Controller(base_controller.BaseController):
    ...
    def list_users(
        ...
        **kwargs,
        ...
        def get_instance_from_response(response: requests.Response) -> Any:
            return list_users_response.ListUsersResponse.from_response(response)
    ...
    def create_user(
        ...
        def get_instance_from_response(response: requests.Response) -> Any:
            return create_user_response.CreateUserResponse.from_response(response)
    ...
    def update_user_profile(
        ...
        **kwargs,
        ...
        def get_instance_from_response(response: requests.Response) -> Any:
            return edit_profile_response.EditProfileResponse.from_response(response)
    ...
    def read_user(
        ...
        def get_instance_from_response(response: requests.Response) -> Any:
            return read_user_response.ReadUserResponse.from_response(response)
    ...
    def update_user(
        ...
        **kwargs,
        ...
        def get_instance_from_response(response: requests.Response) -> Any:
            return update_user_response.UpdateUserResponse.from_response(response)
...
class UsersV2ControllerPaginator(base_controller.BaseController):
    """A Controller to access Endpoints for users resource with pagination."""

    def __init__(self, config: configuration.Configuration) -> None:
        super().__init__(config)
        self.controller = UsersV2Controller(config)
