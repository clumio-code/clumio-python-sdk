...
class UsersV2Controller(base_controller.BaseController):
    ...
    def create_user(self, body: create_user_v2_request.CreateUserV2Request, **kwargs) -> Union[
    ...
    def change_password(
        self, body: change_password_v2_request.ChangePasswordV2Request, **kwargs
    ) -> Union[
    ...
    def update_user_profile(
        self, body: update_user_profile_v2_request.UpdateUserProfileV2Request, **kwargs
    ) -> Union[
    ...
    def update_user(
        self, user_id: int, body: update_user_v2_request.UpdateUserV2Request, **kwargs
    ) -> Union[
