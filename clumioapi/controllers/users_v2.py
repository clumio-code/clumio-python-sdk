...
class UsersV2Controller(base_controller.BaseController):
    ...
    def list_users(
        ...
        **kwargs,
        ...
        obj = list_users_response.ListUsersResponse.from_dictionary(resp.json())
        if raw_response:
            return resp, obj
        return obj
    ...
    def create_user(
        ...
        obj = create_user_response.CreateUserResponse.from_dictionary(resp.json())
        if raw_response:
            return resp, obj
        return obj
    ...
    def update_user_profile(
        ...
        **kwargs,
        ...
        obj = edit_profile_response.EditProfileResponse.from_dictionary(resp.json())
        if raw_response:
            return resp, obj
        return obj
    ...
    def read_user(self, user_id: int | None = None, **kwargs) -> Union[
        ...
        obj = read_user_response.ReadUserResponse.from_dictionary(resp.json())
        if raw_response:
            return resp, obj
        return obj
    ...
    def update_user(
        ...
        **kwargs,
        ...
        obj = update_user_response.UpdateUserResponse.from_dictionary(resp.json())
        if raw_response:
            return resp, obj
        return obj
