        ...
        **kwargs,
        ...
        try:
            ...
            raise clumio_exception.ClumioException(
                'Error occurred while executing restore_aws_dynamodb_table', error=http_error
            )

        obj = restore_dynamo_db_table_response.RestoreDynamoDBTableResponse.from_dictionary(
            resp.json()
        )
        if raw_response:
            return resp, obj
