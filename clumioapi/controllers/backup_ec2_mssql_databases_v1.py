...
class BackupEc2MssqlDatabasesV1Controller:
    ...
    def list_backup_ec2_mssql_databases(
        ...
        sort: str | None = None,
        filter: (
            backup_ec2_mssql_databases_types.ListBackupEc2MssqlDatabasesV1FilterT
            | backup_ec2_mssql_databases_types.ListBackupEc2MssqlDatabasesV1FilterTypeDef
            | None
        ) = None,
        embed: str | None = None,
        **kwargs,
        ...
        _query_parameters = {
            ...
            'filter': api_helper.to_filter_query_str(
                filter, backup_ec2_mssql_databases_types.ListBackupEc2MssqlDatabasesV1FilterT
            ),
            'embed': embed,
        }
...
class BackupEc2MssqlDatabasesV1ControllerPaginator:
    ...
    def list_backup_ec2_mssql_databases(
        ...
        **kwargs,
        ...
        """
        controller = BackupEc2MssqlDatabasesV1Controller(self.controller)
        while True:
            response = controller.list_backup_ec2_mssql_databases(
