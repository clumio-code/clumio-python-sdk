    ...
    def list_audit_trails(
        ...
        **kwargs,
        ...
        def get_instance_from_response(response: requests.Response) -> Any:
            return list_audit_trails_response.ListAuditTrailsResponse.from_response(response)
...
class AuditTrailsV1ControllerPaginator(base_controller.BaseController):
    """A Controller to access Endpoints for audit-trails resource with pagination."""

    def __init__(self, config: configuration.Configuration) -> None:
        super().__init__(config)
        self.controller = AuditTrailsV1Controller(config)
    ...
    def list_audit_trails(
        ...
        **kwargs,
        ...
        start = start or '1'
        while True:
            response = self.controller.list_audit_trails(
