        ...
        **kwargs,
        ...
        try:
            ...
            raise clumio_exception.ClumioException(
                'Error occurred while executing list_ec2_mssql_failover_clusters', error=http_error
            )

        obj = list_ec2_mssqlfc_is_response.ListEC2MSSQLFCIsResponse.from_dictionary(resp.json())
        if raw_response:
            return resp, obj
        return obj
