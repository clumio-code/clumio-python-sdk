...
class BackupAwsEc2InstancesV1Controller:
    ...
    def list_backup_aws_ec2_instances(
        ...
        **kwargs,
        ...
        def get_instance_from_response(resp: requests.Response) -> Any:
            return list_ec2_backups_response.ListEC2BackupsResponse.from_response(resp)
    ...
    def create_backup_aws_ec2_instance(
        ...
        **kwargs,
        ...
        def get_instance_from_response(resp: requests.Response) -> Any:
            return on_demand_ec2_backup_response.OnDemandEC2BackupResponse.from_response(resp)
    ...
    def read_backup_aws_ec2_instance(
        ...
        def get_instance_from_response(resp: requests.Response) -> Any:
            return read_ec2_backup_response.ReadEC2BackupResponse.from_response(resp)
...
class BackupAwsEc2InstancesV1ControllerPaginator:
    ...
    def list_backup_aws_ec2_instances(
        ...
        **kwargs,
        ...
        """
        controller = BackupAwsEc2InstancesV1Controller(self.controller)
        while True:
            response = controller.list_backup_aws_ec2_instances(
