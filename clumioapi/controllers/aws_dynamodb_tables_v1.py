...
class AwsDynamodbTablesV1Controller(base_controller.BaseController):
    ...
    def list_aws_dynamodb_tables(
        ...
        # Prepare query URL
        _url_path = f'{self.config.base_path}/datasources/aws/dynamodb-tables'
    ...
    def read_aws_dynamodb_table(
        self, table_id: str, embed: str = None
        ...
        # Prepare query URL
        _url_path = f'{self.config.base_path}/datasources/aws/dynamodb-tables/{table_id}'
