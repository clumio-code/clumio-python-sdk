...
class ReportComplianceRunsV1Controller(base_controller.BaseController):
    ...
    def list_compliance_report_runs(
        self, configuration_id: str, limit: int, start: str, filter: str, **kwargs
    ) -> Union[
        ...
        if self.config.raw_response:
            return resp, list_compliance_runs_response.ListComplianceRunsResponse.from_dictionary(
                resp.json()
            )
        return list_compliance_runs_response.ListComplianceRunsResponse.from_dictionary(resp.json())

    def create_compliance_report_run(
        self,
        configuration_id: str,
        body: create_compliance_report_run_v1_request.CreateComplianceReportRunV1Request,
        **kwargs,
    ) -> Union[
        ...
        if self.config.raw_response:
            return resp, create_compliance_run_response.CreateComplianceRunResponse.from_dictionary(
                resp.json()
            )
        return create_compliance_run_response.CreateComplianceRunResponse.from_dictionary(
            resp.json()
        )

    def delete_compliance_report_run(
        self, configuration_id: str, run_id: str, **kwargs
    ...
    def send_compliance_report_run_email(
        ...
        configuration_id: str,
        run_id: str,
        body: send_compliance_report_run_email_v1_request.SendComplianceReportRunEmailV1Request,
        **kwargs,
    ) -> Union[
        ...
        if self.config.raw_response:
            return (
                resp,
                send_compliance_run_email_response.SendComplianceRunEmailResponse.from_dictionary(
                    resp.json()
                ),
            )
        return send_compliance_run_email_response.SendComplianceRunEmailResponse.from_dictionary(
            resp.json()
        )
