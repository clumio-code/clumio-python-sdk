...
class ReportComplianceRunsV1Controller(base_controller.BaseController):
    ...
    def list_compliance_report_runs(
        ...
        **kwargs,
        ...
        return list_compliance_runs_response.ListComplianceRunsResponse.from_dictionary(resp)

    def create_compliance_report_run(
        self,
        configuration_id: str,
        body: create_compliance_report_run_v1_request.CreateComplianceReportRunV1Request = None,
        **kwargs,
    ) -> Union[
        ...
        return create_compliance_run_response.CreateComplianceRunResponse.from_dictionary(resp)
    ...
    def send_compliance_report_run_email(
        ...
        configuration_id: str,
        run_id: str,
        body: send_compliance_report_run_email_v1_request.SendComplianceReportRunEmailV1Request = None,
        **kwargs,
    ) -> Union[
