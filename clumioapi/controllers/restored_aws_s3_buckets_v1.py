...
class RestoredAwsS3BucketsV1Controller(base_controller.BaseController):
    ...
    def restore_aws_s3_bucket(
        self, body: restore_aws_s3_bucket_v1_request.RestoreAwsS3BucketV1Request = None, **kwargs
    ) -> Union[
        ...
        if self.config.raw_response:
            return resp, restore_s3_bucket_response.RestoreS3BucketResponse.from_dictionary(
                resp.json()
            )
        return restore_s3_bucket_response.RestoreS3BucketResponse.from_dictionary(resp)

    def preview_aws_s3_bucket(
        self,
        bucket_id: str,
        body: preview_aws_s3_bucket_v1_request.PreviewAwsS3BucketV1Request = None,
        **kwargs,
    ) -> Union[
        ...
        if self.config.raw_response:
            return resp, preview_s3_bucket_response.PreviewS3BucketResponse.from_dictionary(
                resp.json()
            )
        return preview_s3_bucket_response.PreviewS3BucketResponse.from_dictionary(resp)

    def preview_details_aws_s3_bucket(self, bucket_id: str, preview_id: str, **kwargs) -> Union[
        ...
        if self.config.raw_response:
            return (
                resp,
                preview_details_s3_bucket_response.PreviewDetailsS3BucketResponse.from_dictionary(
                    resp.json()
                ),
            )
        return preview_details_s3_bucket_response.PreviewDetailsS3BucketResponse.from_dictionary(
            resp
        )
