...
class RestoredAwsS3BucketsV1Controller(base_controller.BaseController):
    ...
    def restore_aws_s3_bucket(
        self, body: restore_aws_s3_bucket_v1_request.RestoreAwsS3BucketV1Request, **kwargs
    ) -> Union[
        ...
        return restore_s3_bucket_response.RestoreS3BucketResponse.from_dictionary(resp.json())

    def preview_aws_s3_bucket(
        self,
        bucket_id: str,
        body: preview_aws_s3_bucket_v1_request.PreviewAwsS3BucketV1Request,
        **kwargs,
    ) -> Union[
        ...
        return preview_s3_bucket_response.PreviewS3BucketResponse.from_dictionary(resp.json())
