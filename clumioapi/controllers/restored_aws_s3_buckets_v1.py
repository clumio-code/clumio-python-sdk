...
class RestoredAwsS3BucketsV1Controller(base_controller.BaseController):
    ...
    def restore_aws_s3_bucket(
        ...
        **kwargs,
        ...
        def get_instance_from_response(response: requests.Response) -> Any:
            return restore_s3_bucket_response.RestoreS3BucketResponse.from_response(response)
    ...
    def preview_aws_s3_bucket(
        ...
        **kwargs,
        ...
        def get_instance_from_response(response: requests.Response) -> Any:
            return preview_s3_bucket_response.PreviewS3BucketResponse.from_response(response)
...
class RestoredAwsS3BucketsV1ControllerPaginator(base_controller.BaseController):
    """A Controller to access Endpoints for restored-aws-s3-buckets resource with pagination."""

    def __init__(self, config: configuration.Configuration) -> None:
        super().__init__(config)
        self.controller = RestoredAwsS3BucketsV1Controller(config)
