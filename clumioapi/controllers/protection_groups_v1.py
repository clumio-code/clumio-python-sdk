...
class ProtectionGroupsV1Controller(base_controller.BaseController):
    ...
    def list_protection_groups(
        ...
        **kwargs,
        ...
        def get_instance_from_response(response: requests.Response) -> Any:
            return list_protection_groups_response.ListProtectionGroupsResponse.from_response(
                response
            )
    ...
    def read_protection_group(
        ...
        def get_instance_from_response(response: requests.Response) -> Any:
            return read_protection_group_response.ReadProtectionGroupResponse.from_response(
                response
            )
