...
class Ec2MssqlAvailabilityGroupsV1Controller:
    ...
    def list_ec2_mssql_availability_groups(
        ...
        start: str | None = None,
        filter: (
            ec2_mssql_availability_groups_types.ListEc2MssqlAvailabilityGroupsV1FilterT
            | ec2_mssql_availability_groups_types.ListEc2MssqlAvailabilityGroupsV1FilterTypeDef
            | None
        ) = None,
        embed: str | None = None,
        ...
        **kwargs,
        ...
        _query_parameters = {
            ...
            'filter': api_helper.to_filter_query_str(
                filter, ec2_mssql_availability_groups_types.ListEc2MssqlAvailabilityGroupsV1FilterT
            ),
            'embed': embed,
