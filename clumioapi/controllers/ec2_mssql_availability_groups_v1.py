...
class Ec2MssqlAvailabilityGroupsV1Controller(base_controller.BaseController):
    ...
    def list_ec2_mssql_availability_groups(
        ...
        **kwargs,
        ...
        def get_instance_from_response(response: requests.Response) -> Any:
            return list_ec2_mssql_a_gs_response.ListEC2MssqlAGsResponse.from_response(response)
    ...
    def read_ec2_mssql_availability_group(
        ...
        **kwargs,
        ...
        def get_instance_from_response(response: requests.Response) -> Any:
            return read_ec2_mssql_ag_response.ReadEC2MssqlAGResponse.from_response(response)
...
class Ec2MssqlAvailabilityGroupsV1ControllerPaginator(base_controller.BaseController):
    """A Controller to access Endpoints for ec2-mssql-availability-groups resource with pagination."""

    def __init__(self, config: configuration.Configuration) -> None:
        super().__init__(config)
        self.controller = Ec2MssqlAvailabilityGroupsV1Controller(config)
    ...
    def list_ec2_mssql_availability_groups(
        ...
        **kwargs,
        ...
        start = start or '1'
        while True:
            response = self.controller.list_ec2_mssql_availability_groups(
                limit=limit,
                start=start,
                filter=filter,
                embed=embed,
