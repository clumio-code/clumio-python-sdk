        ...
        **kwargs,
        ...
        try:
            ...
            raise clumio_exception.ClumioException(
                'Error occurred while executing list_ec2_mssql_availability_groups',
                error=http_error,
            )

        obj = list_ec2_mssql_a_gs_response.ListEC2MssqlAGsResponse.from_dictionary(resp.json())
        if raw_response:
            return resp, obj
        return obj
        ...
        **kwargs,
        ...
        try:
            ...
            if raw_response:
                return http_error.response, None
            raise clumio_exception.ClumioException(
                'Error occurred while executing read_ec2_mssql_availability_group', error=http_error
            )

        obj = read_ec2_mssql_ag_response.ReadEC2MssqlAGResponse.from_dictionary(resp.json())
        if raw_response:
            return resp, obj
        return obj
