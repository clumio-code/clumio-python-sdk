...
class AwsS3BucketsV1Controller(base_controller.BaseController):
    ...
    def list_aws_s3_buckets(self, limit: int, start: str, filter: str, **kwargs) -> Union[
        ...
        return list_buckets_response.ListBucketsResponse.from_dictionary(resp.json())
    ...
    def read_aws_s3_bucket(self, bucket_id: str, **kwargs) -> Union[
        ...
        return read_bucket_response.ReadBucketResponse.from_dictionary(resp.json())

    def set_bucket_properties(
        self,
        bucket_id: str,
        body: set_bucket_properties_v1_request.SetBucketPropertiesV1Request,
        **kwargs,
    ) -> Union[
        ...
        return set_bucket_properties_response.SetBucketPropertiesResponse.from_dictionary(
            resp.json()
        )
