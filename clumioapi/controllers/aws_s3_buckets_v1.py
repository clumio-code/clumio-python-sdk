...
class AwsS3BucketsV1Controller:
    ...
    def list_aws_s3_buckets(
        ...
        **kwargs,
        ...
        def get_instance_from_response(resp: requests.Response) -> Any:
            return list_buckets_response.ListBucketsResponse.from_response(resp)
    ...
    def read_aws_s3_bucket(
        ...
        def get_instance_from_response(resp: requests.Response) -> Any:
            return read_bucket_response.ReadBucketResponse.from_response(resp)
