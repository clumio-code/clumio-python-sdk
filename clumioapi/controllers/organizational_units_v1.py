...
class OrganizationalUnitsV1Controller(base_controller.BaseController):
    ...
    def create_organizational_unit(
        self,
        embed: str,
        body: create_organizational_unit_v1_request.CreateOrganizationalUnitV1Request,
        **kwargs,
    ) -> Union[
        Union[
    ...
    def patch_organizational_unit(
        ...
        id: str,
        embed: str,
        body: patch_organizational_unit_v1_request.PatchOrganizationalUnitV1Request,
        **kwargs,
    ) -> Union[
        Union[
