...
class OrganizationalUnitsV1Controller:
    ...
    def list_organizational_units(
        ...
        start: str | None = None,
        filter: (
            organizational_units_types.ListOrganizationalUnitsV1FilterT
            | organizational_units_types.ListOrganizationalUnitsV1FilterTypeDef
            | None
        ) = None,
        **kwargs,
        ...
        _query_parameters = {
            ...
            'filter': api_helper.to_filter_query_str(
                filter, organizational_units_types.ListOrganizationalUnitsV1FilterT
            ),
        }
