...
class AwsEnvironmentTagsV1Controller(base_controller.BaseController):
    ...
    def list_aws_environment_tags(
        ...
        **kwargs,
        ...
        return list_aws_tags_response.ListAwsTagsResponse.from_dictionary(resp.json())

    def read_aws_environment_tag(
        self, environment_id: str, tag_id: str, embed: str, lookback_days: int, **kwargs
    ) -> Union[
        ...
        return read_aws_tag_response.ReadAwsTagResponse.from_dictionary(resp.json())
