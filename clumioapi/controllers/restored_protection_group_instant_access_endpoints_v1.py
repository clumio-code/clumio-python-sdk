...
class RestoredProtectionGroupInstantAccessEndpointsV1ControllerPaginator(
    ...
    def __init__(self, config: configuration.Configuration) -> None:
        super().__init__(config)
        self.controller = RestoredProtectionGroupInstantAccessEndpointsV1Controller(config)
    ...
    def list_protection_group_instant_access_endpoints(
        ...
        **kwargs,
        ...
        start = start or '1'
        while True:
            response = self.controller.list_protection_group_instant_access_endpoints(
