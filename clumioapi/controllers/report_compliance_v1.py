...
class ReportComplianceV1Controller(base_controller.BaseController):
    ...
    def create_compliance_report_configuration(
        self,
        body: create_compliance_report_configuration_v1_request.CreateComplianceReportConfigurationV1Request,
        **kwargs,
    ) -> Union[
    ...
    def update_compliance_report_configuration(
        ...
        body: update_compliance_report_configuration_v1_request.UpdateComplianceReportConfigurationV1Request,
        **kwargs,
    ) -> Union[
