        ...
        **kwargs,
        ...
        try:
            ...
            raise clumio_exception.ClumioException(
                'Error occurred while executing list_backup_aws_rds_resources', error=http_error
            )
    ...
    def read_backup_aws_rds_resource(self, backup_id: str | None = None, **kwargs) -> Union[
        ...
        try:
            ...
            if raw_response:
                return http_error.response, None
            raise clumio_exception.ClumioException(
                'Error occurred while executing read_backup_aws_rds_resource', error=http_error
            )
        ...
        **kwargs,
        ...
        try:
            ...
            if raw_response:
                return http_error.response, None
            raise clumio_exception.ClumioException(
                'Error occurred while executing list_aws_rds_resources_option_groups',
                error=http_error,
            )
