...
class AwsRdsResourcesV1Controller(base_controller.BaseController):
    ...
    def list_aws_rds_resources(
        ...
        **kwargs,
        ...
        def get_instance_from_response(resp: requests.Response) -> Any:
            return list_rds_resources_response.ListRdsResourcesResponse.from_response(resp)
    ...
    def read_aws_rds_resource(
        ...
        **kwargs,
        ...
        def get_instance_from_response(resp: requests.Response) -> Any:
            return read_rds_resource_response.ReadRdsResourceResponse.from_response(resp)
