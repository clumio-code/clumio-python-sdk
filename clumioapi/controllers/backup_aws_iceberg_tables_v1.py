...
class BackupAwsIcebergTablesV1Controller:
    ...
    def list_backup_aws_iceberg_tables(
        ...
        sort: str | None = None,
        filter: (
            backup_aws_iceberg_tables_types.ListBackupAwsIcebergTablesV1FilterT
            | backup_aws_iceberg_tables_types.ListBackupAwsIcebergTablesV1FilterTypeDef
            | None
        ) = None,
        **kwargs,
        ...
        _query_parameters = {
            ...
            'filter': api_helper.to_filter_query_str(
                filter, backup_aws_iceberg_tables_types.ListBackupAwsIcebergTablesV1FilterT
            ),
        }
