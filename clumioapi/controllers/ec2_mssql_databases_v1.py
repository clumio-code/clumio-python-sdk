        ...
        **kwargs,
        ...
        try:
            ...
            raise clumio_exception.ClumioException(
                'Error occurred while executing list_ec2_mssql_databases', error=http_error
            )
    ...
    def read_ec2_mssql_database(
        ...
        try:
            ...
            if raw_response:
                return http_error.response, None
            raise clumio_exception.ClumioException(
                'Error occurred while executing read_ec2_mssql_database', error=http_error
            )
        ...
        **kwargs,
        ...
        try:
            ...
            if raw_response:
                return http_error.response, None
            raise clumio_exception.ClumioException(
                'Error occurred while executing list_ec2_mssql_database_pitr_intervals',
                error=http_error,
            )
