...
class Ec2MssqlDatabasesV1Controller(base_controller.BaseController):
    ...
    def read_ec2_mssql_database(
        ...
        def get_instance_from_response(response: requests.Response) -> Any:
            return read_ec2_mssql_database_response.ReadEC2MSSQLDatabaseResponse.from_response(
                response
            )
...
class Ec2MssqlDatabasesV1ControllerPaginator(base_controller.BaseController):
    """A Controller to access Endpoints for ec2-mssql-databases resource with pagination."""

    def __init__(self, config: configuration.Configuration) -> None:
        super().__init__(config)
        self.controller = Ec2MssqlDatabasesV1Controller(config)
    ...
    def list_ec2_mssql_databases(
        ...
        **kwargs,
        ...
        start = start or '1'
        while True:
            response = self.controller.list_ec2_mssql_databases(
                limit=limit,
                start=start,
                filter=filter,
                embed=embed,
    ...
    def list_ec2_mssql_database_pitr_intervals(
        ...
        **kwargs,
        ...
        start = start or '1'
        while True:
            response = self.controller.list_ec2_mssql_database_pitr_intervals(
