...
class Ec2MssqlDatabasesV1Controller(base_controller.BaseController):
    ...
    def list_ec2_mssql_databases(
        ...
        return list_ec2_mssql_databases_response.ListEC2MSSQLDatabasesResponse.from_dictionary(
            resp.json()
        )

    def read_ec2_mssql_database(self, database_id: str, lookback_days: int, **kwargs) -> Union[
        ...
        return read_ec2_mssql_database_response.ReadEC2MSSQLDatabaseResponse.from_dictionary(
            resp.json()
        )

    def list_ec2_mssql_database_pitr_intervals(
        self, database_id: str, limit: int, start: str, filter: str, **kwargs
    ) -> Union[
